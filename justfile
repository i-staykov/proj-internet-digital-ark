...
#
# On naming: `ark check` validates the DATA (eleven integrity invariants over
...
# the integrity gate: eleven invariants over the store, non-zero exit on any failure
check-data:
    uv run ark check
