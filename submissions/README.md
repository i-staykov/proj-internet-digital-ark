...
| phase-6 | **built, not sent** | `merged260817-2` | 17,733 | 14,358.92 | 0.118894% | **packaged 2026-08-18T16:09:22Z, awaiting a decision on whether to send** | the scoring rules measured into a submission-timing model, InterNIC zone delegations priced and pending approval, the InterNIC and `.au` registry families closed |
