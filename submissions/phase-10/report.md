...
`merged260917-2`. "The specification" is your
...
723 registrable domains are absent from your six files in every year; the rest fills years
on names you hold.
...
Cumulative credited percentage 79.4048%: each scored round at the figure you credited, this round at its own unverified 0.5870%. Time-weighted score 6.88 + 6.302372 + 5.687792 + 0.944228 = 19.814392, your own scores for rounds 6, 7, 8 and 9. Under the specification's time-weighted score this round is t = 50, whole days since the 2 August assignment. Domain-Year Score: S = 10 x (0.586969 / 50) = 0.117394. Candidate-Pool Score: S = 10 x (0.138205 / 50) = 0.027641.
...
| `nypw_timemap_hostgrain` | hostname | the row's own 14-digit capture timestamp, in the archive's Not Your Parents' Web first-capture index | 9,717 | 4,106 |
...
your release: 4,265 hosts of the 1996-1997 surveys, candidates by your ruling of 5 September that
...
**Not one of the 591,027 records submitted is already in the baseline; 28 of 28 reconciliation checks pass.** Per-check verdicts: `audit/merge_audit_ark_*.json`; the per-year form, in your column names: `audit/merge_stats_ark_*.csv`.
