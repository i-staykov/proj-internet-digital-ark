...
evidence, the corroboration split gates anything a human typed, and ten invariants run on every pass.
...
```bash
just ship            # quiesce ingestion, export, run the ten invariants, package, verify
```
