...
| [docs/phase6-plan.md](docs/phase6-plan.md) | this round's plan, in plain terms. The previous round's is [docs/phase5-plan.md](docs/phase5-plan.md), kept as history |
