...
- The politeness rules are in `docs/lore/rules.md`, section Engines and politeness: two archive
...
- Read the terms in full, and the whole robots.txt of the host in the download URL, before the
  first request. The hosts that refuse us by name are listed in `docs/lore/traps.md`; so are the
