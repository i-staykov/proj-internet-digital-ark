...
- The rules live in `docs/lore/rules.md`, the measured figures in `docs/lore/laws.md`, the post-mortems in
  `docs/lore/traps.md`. Add to the right one instead of restating it elsewhere: a rule in two places
  drifts.
- No em-dashes or en-dashes, here or anywhere.
