...
| [queue.md](registers/queue.md) | Generated. **The one list Ivo decides from**: only what he alone can settle, the send and a new evidence class, at its measured figure where one exists. A lead inside the standing bounds is read and banked without asking, and is not listed | when he has a moment to rule |
