...
### Approve, refuse or downgrade usenet_body_url_hostnames / link_source: 93,590 EE measured

Hosts of explicit `http`, `https` and `ftp` URLs in Usenet post BODIES, at hostname grain, over
four pools read WHOLE and priced as one union against the live store: 155 GB, 252.3M posts, 106.7M
in window, 127,336.8919 EE gross, **93,590.2605 EE after the ADR-007 alias seam and a sampled
6.25% fiction rate**. uk and comp were fetched and read whole overnight on 2026-09-04; comp is the
densest at 1,701 EE per GB gross against 851 for the two original pools, and the overlap between
hierarchies is only 15.9%, so the 262 GB still unread is worth reading rather than projecting. No projection anywhere in it.
Beside it, needing no hostname decision, 57,227 registrable-years worth 33,172.8989 EE before the
...
Worth: 93,590 EE measured, the largest single lane found in phase 8 and 8.2% of the gate. Bytes are on disk; journals rebuild in about 25 minutes a pool.
