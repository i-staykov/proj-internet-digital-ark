...
| http_fetch_logs_1995_ita_nasa_client_hostnames | 2026-09-19, laptop | Jul 1995, candidate only | fetch.py streamed the 20.7 MB gzip in-stream | nothing in window: every stamp is Jul 1995, so n... | 7,378 of 7,390 parents held | 21,932.3012 EE hostname grain, 7.0469 EE registrable (2026-09-19) | ee_hostname 21,930.68 of 21,932.30, so all but 1.6 EE ships nowhere until the outlet is ruled | 1,891,715 lines, 61,317 hosts | FIND (stranded) | https://ita.ee.lbl.gov/traces/NASA_access_log_Jul95.gz |
...
| wlv-cybermetrics-au-july-2000-link-database | 2026-09-18, fleet 20260918T2106Z | n/a | `fetch.py --to -` streamed the .exe to `extract.py`, which read the zip from memory | the crawler's own output-file timestamp, kept as the DOS mtime in each | n/a | fleet 5,206.1 EE, store not re-priced: verify disputed (2026-09-18) | n/a | n/a | FIND (disputed) | <https://web.archive.org/web/20040603081706id_/http://cybermetrics.wlv.ac.uk/database/aus_july_2000.exe> |
...
| hostname_parent_year_derivation | 2026-09-07, fleet 20260907T1056Z | n/a | reusable, and the reusable part is bigger than this result. see the fleet hypothesis ledger | the year of the annual file the hostname was found in. | n/a | 8804.3 EE (2026-09-07) | no probe was needed and none was taken. | n/a | FIND | n/a |
...
| ia_derivative_deposits_hostname_grain | 2026-09-07, fleet 20260907T1056Z | n/a | see the fleet hypothesis ledger | field 1 of every row is the crawl year, machine-written by UKWA when it derived the graph from the ~2.5bn 200-OK responses of the JISC UK We | n/a | 101001.7 EE (2026-09-07) | see the fleet hypothesis ledger | n/a | FIND | <https://web.archive.org/web/20200106181208id_/https://www.webarchive.org.uk/datasets/ukwa.ds.2/linkage/host-linkage.tsv.gz> |
