...
|---|---|---|---|---|---|---|---|---|---|---|
| ia-node-host-cdx-file-ia600702-hostgrain | 2026-09-21, laptop | 1997-2012 | public 57.6 GB gzip CDX of every capture on IA node ia600702, downloading at 1.7 MB/s | field 2, the capture stamp | n/a | head 100 MB: 2.0M rows, 28% stamped 1997-2001, all IP-literal keys (SURT order), 0 EE; hosts follow; price the full file (2026-09-21) | archive.org terms | 1 GET, resumable | DOWNLOADING, `bulk_cdx_file` | <https://archive.org/download/host_cdx_ia600702/ia600702.hostcdx.gz> |
...
| ia-arc-extraction-in-window-item-band-sweep | 2026-09-21, fleet 20260921T0906Z | n/a | `extract.py` reads the gzip stream from `fetch.py --to -`, takes field 0 as the SURT, | each CDX row carries its own 14-digit capture stamp in field 2. | n/a | fleet 8,343.6 EE, store not re-priced: verify pending (2026-09-21) | Candidate track incomplete: the annual pass over 456,921 items took 24 minutes and the candidate pass had not returned at the run wall. | n/a | FIND (pending) | n/a |
...
| ia-webdataservices-arc-extraction-per-arc-public-cdx | 2026-09-21, fleet 20260921T0406Z | n/a | ... | the 14-digit capture stamp the crawler wrote into CDX field `b`, quoted here | n/a | fleet 5,107.1 EE, store not re-priced: verify pending (2026-09-21) | n/a | n/a | FIND (pending) | <https://archive.org/download/DARTMOUTH-NBER-RESEARCH-2017-ARCS-20170721000000-04001-04107/DARTMOUTH-NBER-RESEARCH-2017-ARCS-20170721000000-PART-04001-000002.arc.os.cdx.gz> |
