...
|---|---|---|---|---|---|---|---|---|---|---|
| brief-audit: every CDX read is hard-filtered to HTTP 200, and he attached "non-error" to one pattern only | 2026-09-22, fleet 20260922T2006Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-22) | n/a | n/a | FIND | n/a |
...
| computermagazine-ocr-advertiser-registrable-corpus | 2026-09-21, laptop | 1996-2001 | 56 in-window Computer Shopper issues, archive.org OCR text, printed registrable names | the item's own issue date | n/a | store 283.5 EE candidate, 449 new names of 3,273 (2026-09-21); the fleet closed it under the floor at 151 EE on 5 issues | archive.org terms | 56 GETs | SEEDED (candidate) | <https://archive.org/download/ComputerShopper_2001-12/> |
| ia-arc-extraction-in-window-item-band-sweep | 2026-09-21, fleet 20260921T0906Z | n/a | `extract.py` reads the gzip stream from `fetch.py --to -`, takes field 0 as the SURT | each CDX row carries its own 14-digit capture stamp in field 2 | n/a | re-priced on the store: 4.5 EE net-new, the 25 in-window items are banked as `dartmouth_arcs_cdx_hostnames` (C-94) | n/a | n/a | CLOSED, superseded (2026-09-21) | n/a |
...
| ia-webdataservices-arc-extraction-per-arc-public-cdx | 2026-09-21, fleet 20260921T0406Z | n/a | one ARC's public sidecar CDX, the per-item aggregate of which is banked | the 14-digit capture stamp the crawler wrote into CDX field `b` | n/a | re-priced on the store: 0 EE net-new, its parent item is banked whole (C-94) | n/a | n/a | CLOSED, superseded (2026-09-21) | <https://archive.org/download/DARTMOUTH-NBER-RESEARCH-2017-ARCS-20170721000000-04001-04107/> |
| http-fetch-logs-1995-ita-reverse-resolved-client-and-fetched-web-hosts | 2026-09-19, fleet 20260919T1906Z | n/a | fetch.py to the probe directory, extract.py parses the gzip in-stream, whole file, | `unicomp6.unicomp.net - - [01/Jul/1995:00:00:06 -0400] "GET | n/a | fleet 21,932.3 EE, store not re-priced: price_hostnames.py exited 1 (2026-09-19) | Candidate track only. | n/a | FIND (confirmed) | <https://ita.ee.lbl.gov/traces/NASA_access_log_Jul95.gz,> |
...
| ddn-hosts-txt-1992-1995-editions-military-hostgrain | 2026-09-19, fleet 20260919T1306Z | n/a | `extract.py`, kept beside this file. It reads field 3 of `HOST` and `GATEWAY` records, | nothing does at the record level, by design. | n/a | fleet 6,401.3 EE, store not re-priced: price_hostnames.py exited 1 (2026-09-19) | n/a | n/a | FIND (confirmed) | n/a |
...
| spacekookie-google-groups-usenet-tarballs-server-header-hosts-reprice | 2026-09-17, laptop re-price | n/a | the confirmed FIND re-priced at hostname grain on the live store | the news server's own NNTP-Posting-Date, C-83 shape | n/a | 120 net-new host-years, 93.9 EE against the fleet's 1,450.5: 416 of 560 hosts were already in the store by the time the laptop looked (2026-09-17) | n/a | n/a | CLOSED | <https://archive.org/download/spacekookie-de-usenet-archive/> |
| law-webbase-2001-urls-hostgrain-retest | 2026-09-17, laptop re-price | n/a | hostname grain, the one unit the 2026-09-01 close never tested | the LAW webbase-2001 crawl stamp on the redistributed URL list | n/a | 5,913 net-new host-years, 4,088.6 EE measured, 0 EE eligible: every one is www.<a name already held that year>, which the ingest refuses (2026-09-17) | n/a | n/a | CLOSED | <http://data.law.di.unimi.it/webdata/webbase-2001/webbase-2001.urls.gz> |
...
| uucp-mapping-project-map-records-munnari-1998 | 2026-09-17, laptop re-price | n/a | the UUCP map records mirrored at munnari.oz.au | the map file's own mtime, 1998-05-03, and the record's date field | n/a | 273 net-new pairs, mean weight 0.7864, about 215 EE: good weight, no volume (2026-09-17) | n/a | n/a | CLOSED | <ftp://munnari.oz.au/pub/uucp.map/> |
| usenethistorical-isp-hierarchy-nntp-posting-host-bulk | 2026-09-17, laptop re-price | n/a | the ISP hierarchy partitions read at NNTP-Posting-Host grain | the server's own stamp on the article, C-83 shape | n/a | 1,551 net-new host-years, 1,389.1 EE at hostname grain (22 pairs, 17.6 EE registrable), under the 5,000 EE bar (2026-09-17) | n/a | n/a | CLOSED | n/a |
...
| zenodo-banner-ads-hostgrain-reextract | 2026-09-16, fleet 20260916T0612Z | n/a | census, not sample. The whole 215 MB was streamed line by line rather than parsed into a | the 14-digit Wayback capture stamp the depositors carry on every banner "timestamp": "20000302182645", "image_url": "https://web.archive.org | n/a | fleet 1,616.3 EE, store not re-priced: verify pending (2026-09-16) | n/a | n/a | FIND (pending) | <https://zenodo.org/records/8408539/files/banners_output_20230930.json> |
...
| brief-audit: the hostname wall still applies a condition C-83 retired, and it costs 9,923 EE | 2026-09-16, fleet 20260916T0406Z | n/a | n/a | n/a | n/a | 5998.8264 EE (2026-09-16) | An audit question about a condition, not a source. Retired 2026-09-20 so it stops counting as headroom | n/a | NOT A SOURCE | n/a |
...
| bulk_access_whois_files_1999_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and cheap: when a hypothesis asserts "a purchasable FILE existed", screen at DOCUMENT level before spending any probe budget, because a contractual deliverable leaves a paper trail and no bytes. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | no payload existed to probe. | n/a | CLOSED | <https://dataverse.harvard.edu/api/search> |
| cctld_register_editions_published_inside_the_window | 2026-09-09, fleet 20260909T1449Z | n/a | three reusable pieces, all cheap. see the fleet hypothesis ledger | nothing was reached. | n/a | 0 EE (2026-09-09) | the kill screen exactly as written, "list the archived ftp trees of the five registries and any archive.org item naming one". | n/a | CLOSED | <https://web.archive.org/web/20000303075155id_/ftp://ftp.nic.it/> |
| citeseer_researchindex_crawl_url_metadata | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0.0 EE (2026-09-09) | the kill screen the hypothesis set was "read the metadata schema of one dump and 1,000 records". | n/a | CLOSED | <https://citeseerx.ist.psu.edu/oai2?verb=Identify> |
| dmoz_odp_bulk_rdf_dump_in_window | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | the dump would date itself, both by the memento datetime and by ODP's own `<lastUpdate>` element per entry. | n/a | 0 EE (2026-09-09) | this is the ROOM lead the leg switched to after slugs 5 and 6 died, chosen because the Open Directory shipped it see the fleet hypothesis ledger | n/a | BLOCKED | <http://web.archive.org/web/20000815053618id_/http://dmoz.org/rdf/content.rdf.u8.gz>,> |
| dotcomdirectory_nsi_registry_directory_2000_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable and worth lifting out of this lead, because it see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | the smallest representative piece is `/nsi/startbrowse.hm`, the site's own browse entry point, read whole at 40,850 B from the 2000-03-03 capture. | n/a | CLOSED | <https://web.archive.org/web/20000303015856id_/http://www.dotcomdirectory.com:80/nsi/startbrowse.hm>,> |
| enron_corpus_correspondent_domains_1999_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | two reusable results, and the second is the one worth keeping. see the fleet hypothesis ledger | the message's own `Date:` header, written by the sending MUA/MTA, one per message, 516,627 of 517,425 present. | n/a | 462.2 EE (2026-09-09) | no probe was needed and none was taken. | n/a | CLOSED | <https://archive.org/download/2011_04_02_enron_email_dataset/enron_mail_20110402.tgz>,> |
| funet_netinfo_tree_era_artifact_sweep | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it is a cheap habit rather than an insight. see the fleet hypothesis ledger | the server's own directory mtime, which is what killed it: every candidate subtree is stamped before 1996 by the mirror itself, so the artif | n/a | 0 EE (2026-09-09) | eight directory listings, no payload. | n/a | CLOSED | <https://ftp.funet.fi/pub/netinfo/>> |
| gtld2001_sunrise_challenge_and_deletion_dockets | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | the case filing/decision date printed on the docket row dates the disputed name to that year; | n/a | 0 EE (2026-09-09) | WIPO case list page `casesx/list.jsp?prefix=D&year=2001&seq_min=1&seq_max=199`, 75,304 B, 203 case rows, 347 distinct registrable domains extr see the fleet hypothesis ledger | n/a | CLOSED | <https://www.wipo.int/amc/en/domains/casesx/index.html>> |
| ia_arc_payload_read_whole_hostgrain | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | the ARC record header's own 14 digit fetch timestamp, which is genuine master-grade self-dating evidence and is why this family keeps gettin | n/a | 0 EE (2026-09-09) | the kill screen was "one range request against see the fleet hypothesis ledger | n/a | BLOCKED | <https://archive.org/download/green-000016-19990818165005-935025333-c/green-000016-19990818165005-935025399.arc.gz>> |
| info_biz_2001_landrush_registration_corpora | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | for the Sunrise families, the registry's own Sunrise period (2001-07-25 to 2001-08-31) named in the challenge record, which dates the regist | n/a | 0 EE (2026-09-09) | the recovered successor of the 01:24Z leg, worked first as the brief requires. | n/a | CLOSED | <https://web.archive.org/web/20011130213604id_/http://www.afilias.com/> |
| linux_counter_registered_machine_hostnames_1996_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it is the sharpest thing this leg found because it is a PRE-SCREEN that costs nothing. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the hypothesis' own kill screen, fired exactly as written: fetch one machine list or dump and quote the column names. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://counter.li.org/reports/machines.txt>> |
| lists_apache_org_received_chain_full_window | 2026-09-09, fleet 20260909T1449Z | n/a | three reusable pieces, and the first is the one to keep. see the fleet hypothesis ledger | the message's own `Date:` header, second resolution, written by the sender's MUA and corroborated by the qmail `Received:` line's own stamp | n/a | 788.8 EE (2026-09-09) | not a probe. | n/a | CLOSED | <https://lists.apache.org/api/mbox.lua?list=dev&domain=httpd.apache.org&d=YYYY-MM> |
| marc_catalog_856_url_fields_1996_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and the transferable part is the test, not the source. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | two MARC21 dumps from the archive.org `ol_data` collection, smallest file of each. | n/a | CLOSED | <https://archive.org/download/marc_loc_2016/BooksAll.2016.part43.utf8>> |
| oclc_web_characterization_random_ip_sample_1997_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, two pieces. see the fleet hypothesis ledger | sound and unusually clean, which is why the lead was worth nine requests. | n/a | 0 EE (2026-09-09) | nine requests, all to Wayback replay and TimeMap, no CDX. | n/a | BLOCKED | <https://web.archive.org/web/20010331211839id_/http://wcp.oclc.org:80/main.htm>> |
| openpgp_keyserver_dump_key_creation_stamps | 2026-09-09, fleet 20260909T1449Z | n/a | worth keeping as negative knowledge because the idea is a see the fleet hypothesis ledger | an OpenPGP public key packet (tag 6) carries a 4-byte key creation time written by the generating software, and the self-signature over each | n/a | 0 EE (2026-09-09) | no bytes of key material were reachable, so no domains were extracted and no held fraction exists. | n/a | BLOCKED | <https://mirror.cyberbits.eu/> |
| pandora_nla_instance_path_hostgrain | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it generalises past this lead. see the fleet hypothesis ledger | the `YYYY-MMDD` component of the delivery path, which is real. | n/a | 0 EE (2026-09-09) | no probe possible. | n/a | BLOCKED | <https://pandora.nla.gov.au/robots.txt>,> |
| record_stamp_vs_observation_stamp_screen | 2026-09-09, fleet 20260909T1449Z | n/a | the whole file is the method. see the fleet hypothesis ledger | the screen itself. | n/a | 0 EE (2026-09-09) | not a source. | n/a | CLOSED | <https://archive.org/download/marc_columbia/Columbia-extract-20221130-020.mrc>> |
| registrar_new_registration_bulk_pages_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it is a HARNESS finding rather than a sou see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the three densest A-Z listing pages of the artifact the 01:24Z leg named (`thedomainlist.com/{A,c,s}.htm` at the 2001-01-24 crawl, 17,887 + 29,131 + 19,604 B read whole via `id_` replay). | n/a | CLOSED | <https://web.archive.org/web/20010124id_/http://www.thedomainlist.com/A.htm>> |
| reopen_fleet | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | URLMerchant 2000 pages carry the same machine-written generator stamp as the banked class, e.g. | n/a | 0 EE (2026-09-09) | URLMerchant domain_<letter>.html at Oct 2000 Wayback captures, 5 disjoint letter pages (a, b, c, d, m), 500 distinct names, measured wi see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20001023190136id_/http://www.urlmerchant.com/domains/domain_a.html> |
| ripe_hostcount_publisher_directory_confirmation | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it is the cheap half of any "the raw output must be somewhere" lead. see the fleet hypothesis ledger | nothing, at hostname grain. | n/a | 0 EE (2026-09-09) | four requests, all listings and two small text files, no payload worth fetching. | n/a | CLOSED | <https://ftp.ripe.net/ripe/hostcount/>> |
| rwhois_isp_customer_network_records | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and it generalises past rwhois. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | no in-window rwhois RESPONSE set exists to probe. | n/a | CLOSED | <https://ftp.arin.net/pub/rwhois/>> |
| sep11_web_archive_host_list_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable and it is the cheaper half of an availability oracle. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | no payload was reachable, so the probe is the existence layer itself, run over three independent indexes. | n/a | BLOCKED | <http://sep11.archive.org/> |
| site_search_service_customer_crawl_records | 2026-09-09, fleet 20260909T1449Z | n/a | reusable and it generalises past this lead. see the fleet hypothesis ledger | the crawl date printed after the byte size on each result row (`- 27 kB - Nov 6, 2020`). | n/a | 0 EE (2026-09-09) | the smallest representative piece IS one crawl record, and I read one whole. | n/a | CLOSED | <http://www.sitelevel.com/query?crid=<id>&query=<q>> |
| third_party_cache_and_proxy_access_logs_1996_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | the reusable part is the kill order, and it is cheap. see the fleet hypothesis ledger | nothing survives to date. | n/a | 0 EE (2026-09-09) | no payload was reachable to probe. | n/a | CLOSED | <http://www.ircache.net:80/Traces/> |
| ukgwa_tna_capture_index_hostgrain | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the A to Z read WHOLE, twice, at two epochs. | n/a | CLOSED | <https://web.archive.org/web/20161127010814id_/http://www.nationalarchives.gov.uk/webarchive/atoz.htm>> |
...
| validator_and_diagnostic_fetch_indexes_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | see the fleet hypothesis ledger | for the Netcraft table, the edition's own generated title and daily rebuild stamp; | n/a | 0.0 EE (2026-09-09) | the hypothesis's own kill screen, run exactly as written: "availability oracle over the four hosts' tool paths. | n/a | CLOSED | <https://web.archive.org/web/20010405032616id_/http://uptime.netcraft.com/up/today/top.avg.html> |
| fallback | 2026-09-09, fleet 20260909T1449Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-09) | agent produced no findings file | n/a | BLOCKED | n/a |
| webarchiv_cz_and_infomall_capture_indexes_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable, and cheap enough to run before proposing any archive whose value rests on volume. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | the smallest representative piece is `https://www.webarchiv.cz/en/browse`, 29,176 B, the archive's own subject browse tree. | n/a | CLOSED | <https://www.webarchiv.cz/en/browse>,> |
| weblogs_changes_ping_stream_2001 | 2026-09-09, fleet 20260909T1449Z | n/a | reusable. see the fleet hypothesis ledger | the file's own root attribute, `<weblogUpdates version="1" updated="Fri, 09 Nov 2001 22:34:00 GMT" count="22490">`, written by the ping serv | n/a | 0.0 EE (2026-09-09) | the artifact's whole surviving in-window population, not a sample. | n/a | CLOSED | <https://web.archive.org/web/20011109223420id_/http://www.weblogs.com:80/changes.xml> |
| datacite_doi_dataset_sweep_early_web | 2026-09-09, fleet 20260909T0309Z | n/a | reusable and cheap, about 90 seconds for the whole namespace. see the fleet hypothesis ledger | nothing new; | n/a | 0 EE (2026-09-09) | 17 DataCite queries over the whole DOI namespace, 195 distinct datasets returned, every title scanned for an in-window year or "early web". | n/a | CLOSED | <https://api.datacite.org/dois?query=...> |
| drum_earlyweb_link_graph_full_tars | 2026-09-09, fleet 20260909T0309Z | n/a | see the fleet hypothesis ledger | each CSV row carries its own crawl date as field 3, YYYYMMDD, e.g. | n/a | 1.1 EE (2026-09-09) | 15 disjoint 1 MiB byte-range windows, 3 per year (at 25/50/75% of each year's tar), read straight out of the live DSpace bitstreams without downloading a part. | n/a | CLOSED | <https://conservancy.umn.edu/server/api/core/bitstreams/<uuid>/content> |
| irc_channel_log_hostmask_grain_2001 | 2026-09-09, fleet 20260909T0309Z | n/a | see the fleet hypothesis ledger | the daemon-side mIRC session header inside the file ("Session Start: Fri Jan 12 00:00:00 2001") agreeing with the log's own filename (#Clone | n/a | 36.1 EE (2026-09-09) | the whole in-window partition of the only in-window hostmask corpus fo see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/download/nirvs-clone-cd-irc-logs/nirv%27s%20CloneCD%20IRC%20logs.zip> |
...
| archiveorg_fulltext_search_for_host_tables | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | for the whois-boilerplate family, the record's own machine-written `Record created on 22-Jun-95. | n/a | 0 EE (2026-09-09) | 11 fingerprint queries against archive.org's real full-text index, about 1,100 result rows and highlight snip see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/services/search/beta/page_production/?service_backend=fts&user_query=> |
| campus_netdb_host_table_dumps | 2026-09-09, fleet 20260909T0150Z | n/a | the reusable part is a NEGATIVE LAW, and it is the point o see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | 26 candidate paths across 16 institutions (Stanford, MIT, Berkeley, UCLA, UC Davis, Purdue, Georgia Tech, CMU, Washington, Michigan, Wisconsin, Texas, Cornell, UIUC, Northwestern, Caltech, Rice) put t | n/a | CLOSED | <https://web.archive.org/web/20010515060653id_/http://netdb.stanford.edu/> |
| commercial_domain_name_list_products_2000_2001 | 2026-09-09, fleet 20260909T0150Z | n/a | reusable, and this is the part worth keeping. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | The kill screen was existence, not payload, so the probe is the file LISTING and not a sample of names: zero bytes of payload moved. | n/a | CLOSED | <https://archive.org/metadata/expired-domain-names-by-day>> |
| datacite_doi_dataset_sweep_early_web | 2026-09-09, fleet 20260909T0150Z | n/a | reusable and cheap, about 90 seconds for the whole namespace. see the fleet hypothesis ledger | nothing new; | n/a | 0 EE (2026-09-09) | 17 DataCite queries over the whole DOI namespace, 195 distinct datasets returned, every title scanned for an in-window year or "early web". | n/a | CLOSED | <https://api.datacite.org/dois?query=...> |
| drum_earlyweb_link_graph_full_tars | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | each CSV row carries its own crawl date as field 3, YYYYMMDD, e.g. | n/a | 1.1 EE (2026-09-09) | 15 disjoint 1 MiB byte-range windows, 3 per year (at 25/50/75% of each year's tar), read straight out of the live DSpace bitstreams without downloading a part. | n/a | CLOSED | <https://conservancy.umn.edu/server/api/core/bitstreams/<uuid>/content> |
| govdocs1_embedded_urls_and_file_stamps | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | the producing application's own `/CreationDate (D:YYYYMMDD...)` inside the PDF, machine-written, or the zip member mtime carried through fro | n/a | 5.9 EE (2026-09-09) | 2 of the 1,000 zips read WHOLE (001.zip 290,926,059 B and 500.zip 295,929,140 B, 1,961 files, 1.28 GB uncompressed). | n/a | CLOSED | <https://corp.digitalcorpora.org/corpora/files/govdocs1/zipfiles/NNN.zip,> |
| grub_distributed_crawler_fetch_reports_2001 | 2026-09-09, fleet 20260909T0150Z | n/a | two reusable pieces. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | The kill screen fired on both of its clauses, at 11 requests and zero payload beyond four small HTML pages. | n/a | CLOSED | <https://web.archive.org/web/20011201id_/http://www.grub.org/usage>,> |
| harvest_soif_gatherer_index_dumps | 2026-09-09, fleet 20260909T0150Z | n/a | reusable, and it is the shape law stated positively. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | TimeMap existence pass over the six named Harvest hosts, then the one tree with a live archive (`www.tardis.ed.ac.uk/harvest/`, 374 mementos, 1998 `id_` replay 200, 1,984 B). | n/a | CLOSED | <http://www.tardis.ed.ac.uk/harvest/> |
| irc_channel_log_hostmask_grain_2001 | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | the daemon-side mIRC session header inside the file ("Session Start: Fri Jan 12 00:00:00 2001") agreeing with the log's own filename (#Clone | n/a | 36.1 EE (2026-09-09) | the whole in-window partition of the only in-window hostmask corpus fo see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/download/nirvs-clone-cd-irc-logs/nirv%27s%20CloneCD%20IRC%20logs.zip> |
| netsaint_bigbrother_status_board_fqdn_rows | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | for the boards, untested, since none is reachable. | n/a | 0 EE (2026-09-09) | The kill screen fired on BOTH of its numbers, and the reason is upstream of the boards: the two operator lists the hypothesis was built on do not exist in the archive. | n/a | CLOSED | <https://web.archive.org/web/20001109024900id_/http://www.netsaint.org/bbstats/index.html>,> |
| nren_host_registry_tables_beyond_janet | 2026-09-09, fleet 20260909T0150Z | n/a | reusable, cheap, and it should be run BEFORE any multi-country hypothesis is costed. see the fleet hypothesis ledger | the memento datetime of the page fixes when the list existed; | n/a | 0.32 EE (2026-09-09) | 6 archived NREN home pages at 2000 (`id_` replay, 46,707 B total): HEAnet, RENATER, SUNET, CESNET, GARR, NORDUnet. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://www.heanet.ie/> |
| realnames_internet_keyword_registry_dumps | 2026-09-09, fleet 20260909T0150Z | n/a | reusable and it generalises past this lead. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | availability oracle by TimeMap over 11 RealNames, Centraal and Netword paths, then `id_` replay of the three that survive. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://www.realnames.com/> |
| registrar_new_registration_bulk_pages_2001 | 2026-09-09, fleet 20260909T0150Z | n/a | the reusable finding is the redirect, and it is worth more than the negative. see the fleet hypothesis ledger | nothing was reached that carries a registry date. | n/a | 0 EE (2026-09-09) | 28 candidate paths across 24 hosts through the TimeMap oracle. | n/a | BLOCKED | <https://web.archive.org/web/20010124031700id_/http://www.thedomainlist.com/search.htm> |
| url_bearing_proxy_cache_log_releases | 2026-09-09, fleet 20260909T0150Z | n/a | see the fleet hypothesis ledger | real, and it is not why this dies. | n/a | 0 EE (2026-09-09) | The hypothesis' kill screen was "read the first 200 lines of the largest candidate and check whether URLs are hashed". | n/a | CLOSED | <https://discmaster.textfiles.com/file/14148/MacHack%202001.toast/pc/The%20Hacks/Network%20Alias/network-alias.tar.gz/network-alias.tar/network-alias/squid/logs/access.log>,> |
| adult_tgp_daily_rotation_editions_2001 | 2026-09-09, fleet 20260909T0119Z | n/a | see the fleet hypothesis ledger | the edition page carries its own machine-written generation stamp, and this is the one place the hypothesis was RIGHT. | n/a | 4.42 EE (2026-09-09) | smallest representative piece = one sextracker Top-100 edition, `http://ranks.sextracker.com/spn.html?cls=ranks&cat=Universe&pg=0-0.html` at 20001206021300, 20 see the fleet hypothesis ledger | n/a | CLOSED | <http://thehun.net/> |
| archiveorg_fulltext_search_for_host_tables | 2026-09-09, fleet 20260909T0119Z | n/a | see the fleet hypothesis ledger | for the whois-boilerplate family, the record's own machine-written `Record created on 22-Jun-95. | n/a | 0 EE (2026-09-09) | 11 fingerprint queries against archive.org's real full-text index, about 1,100 result rows and highlight snip see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/services/search/beta/page_production/?service_backend=fts&user_query=> |
| code_platform_period_zone_dumps | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, and it is the part worth keeping. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | no artifact reached the probe stage. | n/a | CLOSED | n/a |
| commercial_domain_name_list_products_2000_2001 | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, and this is the part worth keeping. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | The kill screen was existence, not payload, so the probe is the file LISTING and not a sample of names: zero bytes of payload moved. | n/a | CLOSED | <https://archive.org/metadata/expired-domain-names-by-day>> |
| cybersquatter_litigation_exhibit_portfolios | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, and it is the transferable part of this run. see the fleet hypothesis ledger | in the filings, nothing. | n/a | 0 EE (2026-09-09) | two probes. | n/a | CLOSED | <https://www.ftc.gov/legal-library/browse/cases-proceedings/012-3095-x010063-zuccarini-john-dba-cupcake-party-et-al>,> |
| grub_distributed_crawler_fetch_reports_2001 | 2026-09-09, fleet 20260909T0119Z | n/a | two reusable pieces. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | The kill screen fired on both of its clauses, at 11 requests and zero payload beyond four small HTML pages. | n/a | CLOSED | <https://web.archive.org/web/20011201id_/http://www.grub.org/usage>,> |
| guestbook_service_dated_entries_2001 | 2026-09-09, fleet 20260909T0119Z | n/a | see the fleet hypothesis ledger | the server-written per-entry stamp, printed to the second beside every entry and unedited since: `September 20th 2001 01:21:20 PM`, `July 5t | n/a | 0 EE (2026-09-09) | the smallest representative piece is ONE page of one live guestbook, `pub7.bravenet.com/gue see the fleet hypothesis ledger | n/a | CLOSED | <https://pub7.bravenet.com/guestbook/show2.php?usernum=550202582&cp=27> |
| harvest_soif_gatherer_index_dumps | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, and it is the shape law stated positively. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | TimeMap existence pass over the six named Harvest hosts, then the one tree with a live archive (`www.tardis.ed.ac.uk/harvest/`, 374 mementos, 1998 `id_` replay 200, 1,984 B). | n/a | CLOSED | <http://www.tardis.ed.ac.uk/harvest/> |
| netsaint_bigbrother_status_board_fqdn_rows | 2026-09-09, fleet 20260909T0119Z | n/a | see the fleet hypothesis ledger | for the boards, untested, since none is reachable. | n/a | 0 EE (2026-09-09) | The kill screen fired on BOTH of its numbers, and the reason is upstream of the boards: the two operator lists the hypothesis was built on do not exist in the archive. | n/a | CLOSED | <https://web.archive.org/web/20001109024900id_/http://www.netsaint.org/bbstats/index.html>,> |
| nren_host_registry_tables_beyond_janet | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, cheap, and it should be run BEFORE any multi-country hypothesis is costed. see the fleet hypothesis ledger | the memento datetime of the page fixes when the list existed; | n/a | 0.32 EE (2026-09-09) | 6 archived NREN home pages at 2000 (`id_` replay, 46,707 B total): HEAnet, RENATER, SUNET, CESNET, GARR, NORDUnet. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://www.heanet.ie/> |
| period_server_disk_images_and_backups | 2026-09-09, fleet 20260909T0119Z | n/a | the reusable part is three archive.org facts, all measured today, and the first is a trap that will silently corrupt any future agent's population. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | item search only, zero payload bytes downloaded, exactly as the CD-ROM closure requires. | n/a | CLOSED | <https://archive.org/metadata/open-vms-desktop> |
| realnames_internet_keyword_registry_dumps | 2026-09-09, fleet 20260909T0119Z | n/a | reusable and it generalises past this lead. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | availability oracle by TimeMap over 11 RealNames, Centraal and Netword paths, then `id_` replay of the three that survive. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://www.realnames.com/> |
| uk_isp_thirdlevel_customer_hostnames | 2026-09-09, fleet 20260909T0119Z | n/a | reusable, and the useful part is the second probe, not the first. see the fleet hypothesis ledger | the memento datetime on an exact-host TimeMap entry would date it, and does date the 19 attestations found; | n/a | 0 EE (2026-09-09) | two probes. | n/a | CLOSED | <https://web.archive.org/web/timemap/link/http://<host>.demon.co.uk/> |
| url_bearing_proxy_cache_log_releases | 2026-09-09, fleet 20260909T0119Z | n/a | see the fleet hypothesis ledger | real, and it is not why this dies. | n/a | 0 EE (2026-09-09) | The hypothesis' kill screen was "read the first 200 lines of the largest candidate and check whether URLs are hashed". | n/a | CLOSED | <https://discmaster.textfiles.com/file/14148/MacHack%202001.toast/pc/The%20Hacks/Network%20Alias/network-alias.tar.gz/network-alias.tar/network-alias/squid/logs/access.log>,> |
| amprnet_ampr_org_dated_host_tables | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and the first item is the one to keep. see the fleet hypothesis ledger | the zone's SOA serial, and it is fatal. | n/a | 0 EE (2026-09-09) | probe and full read are the same thing here, because the artifact is 1.7 MB and streams. | n/a | CLOSED | <https://www.nic.funet.fi/pub/ham/ftp.ucsd.edu/> |
| banner_exchange_member_directories_1998_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and it is a correction to how the availability oracle gets used here. see the fleet hypothesis ledger | nothing usable, and it does not matter. | n/a | 0 EE (2026-09-09) | the kill screen asked for "ONE whole category page priced at registrable grain". | n/a | CLOSED | n/a |
| exposed_zone_files_soa_serial_dated | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | the BIND SOA serial in `YYYYMMDDnn` form, which is machine written and is the exact pattern the reviewer himself names as reusable ("dated r | n/a | 0 EE (2026-09-09) | the kill screen this hypothesis specifies is "30 search results for SOA serial patterns with in-window prefixes beside `IN A` lines", with the rule "under 10 fi see the fleet hypothesis ledger | n/a | CLOSED | n/a |
| game_master_server_snapshot_lists_2000_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | the capture instant of the republished list, and `qstat`'s own query timestamp where a page printed one. | n/a | 5.0 EE (2026-09-09) | `http://www.gameaholic.com/servers/`, `id_` replay of 20000601 (9,277 B) and 20010601 (12,645 B), plus `http://ww see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20000601id_/http://www.gameaholic.com/servers/> |
| isp_dialup_client_config_pop_hostnames | 2026-09-09, fleet 20260909T0027Z | n/a | three reusable pieces, and the second is the one worth keeping. see the fleet hypothesis ledger | for (a) the disc's own dated item metadata, sound but pointing at 1 host. | n/a | 0 EE (2026-09-09) | two probes, because the first killed the artifact and the shape deserved a second. | n/a | CLOSED | <https://discmaster.textfiles.com/file/2917/4-98%20datatid%20cd-rom.iso/internet/ie4uk/STACKND.CAB/msicw.isp> |
| liszt_tilenet_mailing_list_host_census | 2026-09-09, fleet 20260909T0027Z | n/a | reusable. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-09) | the smallest representative piece is one tile.net list detail page, `http://tile.net/lists/a.html` at 19971224220824, 8,446 B. | n/a | CLOSED | <http://tile.net/lists/> |
| memento_aggregator_timemaps_hostgrain | 2026-09-09, fleet 20260909T0027Z | n/a | three reusable pieces, and the third is the valuable one. see the fleet hypothesis ledger | the memento datetime in the `Link` header, machine written by the holding archive. | n/a | 0 EE (2026-09-09) | 16 registrables sampled at random from /projects/ark-data/merged260908/1999.txt, each put through one aggregator TimeMap. | n/a | CLOSED | <https://memgator.cs.odu.edu/timemap/link/<host>> |
| mids_matrix_host_survey_result_files | 2026-09-09, fleet 20260909T0027Z | n/a | reusable and worth keeping. see the fleet hypothesis ledger | real but irrelevant. | n/a | 0 EE (2026-09-09) | the hypothesis turns on one question, "does a surviving MIDS result file carry a NAME column", and the answer is that MIDS never had one to publish. | n/a | CLOSED | <http://ftp.mids.org/pub/> |
| new_net_thirdlevel_hosts_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing from this lane. | n/a | 0 EE (2026-09-09) | the kill screen is the availability oracle over browse, directory and search paths at `new.net`, zero CDX, and it fires harder than the hypothesis expected: there is not even a lookup form in-window. | n/a | CLOSED | <https://web.archive.org/web/20010801000000id_/http://www.new.net/> |
| nsi_host_object_whois_records_hostgrain | 2026-09-09, fleet 20260909T0027Z | n/a | reusable and worth keeping. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | no artifact reached, so no domains were sampled. | n/a | CLOSED | <http://rs.internic.net/domain/> |
| orbs_open_relay_test_databases_2000_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | the row's own test timestamp inside the dump, and the dumps are the "over 30 days old" partition so every row carries a test date. | n/a | 0 EE (2026-09-09) | `http://www.orbs.org/database.html`, memento 2000-03-03, 5,096 B. | n/a | CLOSED | <http://orbs.php.net/DAT/{ok,inputs,inputs.current,outputs,outputs.current,manual}.html> |
| period_server_disk_images_and_backups | 2026-09-09, fleet 20260909T0027Z | n/a | the reusable part is three archive.org facts, all measured today, and the first is a trap that will silently corrupt any future agent's population. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | item search only, zero payload bytes downloaded, exactly as the CD-ROM closure requires. | n/a | CLOSED | <https://archive.org/metadata/open-vms-desktop> |
| proxy_pac_wpad_host_enumerations | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and it is a screen that should be applied BEFORE any guessed-path sweep. see the fleet hypothesis ledger | sound in principle, the capture datetime dates the enumeration, and it is not why this dies. | n/a | 0 EE (2026-09-09) | the kill screen says "500 held names at the four paths, under 20 in-window files CLOSED". | n/a | CLOSED | n/a |
| reopen_fleet | 2026-09-09, fleet 20260909T0027Z | n/a | three reusable parts. see the fleet hypothesis ledger | for the best candidate, the Perry Rovers Anonymous FTP Sites Listing, each site | n/a | 0 EE (2026-09-09) | two measurements, both against the ark-data sync, never against the live store. | n/a | CLOSED | n/a |
| spamcop_public_report_rows_1999_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | the row's own two machine-written columns, "First spam dated" and "Last spam dated", e.g. | n/a | 0 EE (2026-09-09) | the smallest representative piece is ONE snapshot of the complete SpamCop statistics set, the eight pages under `/stats/` at 20000815, 48,361 B in total. | n/a | CLOSED | <https://web.archive.org/web/20000815000000id_/http://spamcop.net/stats/<page>.html> |
| ssl_server_survey_certificate_common_names | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | for SecuritySpace, the edition directory is a machine-written stamp, `/s_survey/data/man.200007/`, and it dates every row on the page to Jul | n/a | 0 EE (2026-09-09) | the smallest representative piece is ONE monthly edition of the only host-bearing page the whole family pu see the fleet hypothesis ledger | n/a | CLOSED | <http://www.lne.com/ericm/papers/ssl_servers.html> |
| streaming_yp_directory_server_rows_1999_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | the capture instant of the directory page, and the row's own "last seen" column. | n/a | 5.0 EE (2026-09-09) | `http://www.shoutcast.com/directory/`, `id_` replay of two in-window captures (20010401000000, 49,439 B and 20011201000000, 49,156 B). | n/a | CLOSED | <https://web.archive.org/web/20010401000000id_/http://www.shoutcast.com/directory/> |
| uk_isp_thirdlevel_customer_hostnames | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and the useful part is the second probe, not the first. see the fleet hypothesis ledger | the memento datetime on an exact-host TimeMap entry would date it, and does date the 19 attestations found; | n/a | 0 EE (2026-09-09) | two probes. | n/a | CLOSED | <https://web.archive.org/web/timemap/link/http://<host>.demon.co.uk/> |
| wayback_non_cdx_host_inventory | 2026-09-09, fleet 20260909T0027Z | n/a | reusable, and this one generalises well beyond archive.org. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the endpoint EXISTS, is not `/cdx`, and answers. | n/a | CLOSED | <https://web.archive.org/__wb/search/host?q=<registrable>> |
| web_served_zone_files_live_sweep | 2026-09-09, fleet 20260909T0027Z | n/a | the transferable rule, and it applies to a whole class of leads in the regi see the fleet hypothesis ledger | the BIND SOA serial in `YYYYMMDDnn`, or an in-file comment. | n/a | 0 EE (2026-09-09) | this lead's kill screen is "30 search operator queries plus one directory sweep, then read the three largest files WHOLE", closing "under 40 in-window files found, with the count and the per query rat | n/a | CLOSED | n/a |
| zonefile_derived_domain_search_sites_1999_2001 | 2026-09-09, fleet 20260909T0027Z | n/a | see the fleet hypothesis ledger | real and machine-written, which is why this was worth the probe: DomainSurfer prints its own build stamp in every page header ("5,381,397 re | n/a | 0 EE (2026-09-09) | the four browsable candidates that actually exist at the three named hosts, read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/19990422034257id_/http://www.domainsurfer.com:80/> |
| amprnet_ampr_org_dated_host_tables | 2026-09-09, fleet 20260908T2345Z | n/a | reusable, and the first item is the one to keep. see the fleet hypothesis ledger | the zone's SOA serial, and it is fatal. | n/a | 0 EE (2026-09-09) | probe and full read are the same thing here, because the artifact is 1.7 MB and streams. | n/a | CLOSED | <https://www.nic.funet.fi/pub/ham/ftp.ucsd.edu/> |
| exposed_zone_files_soa_serial_dated | 2026-09-09, fleet 20260908T2345Z | n/a | see the fleet hypothesis ledger | the BIND SOA serial in `YYYYMMDDnn` form, which is machine written and is the exact pattern the reviewer himself names as reusable ("dated r | n/a | 0 EE (2026-09-09) | the kill screen this hypothesis specifies is "30 search results for SOA serial patterns with in-window prefixes beside `IN A` lines", with the rule "under 10 fi see the fleet hypothesis ledger | n/a | CLOSED | n/a |
| game_master_server_snapshot_lists_2000_2001 | 2026-09-09, fleet 20260908T2345Z | n/a | see the fleet hypothesis ledger | the capture instant of the republished list, and `qstat`'s own query timestamp where a page printed one. | n/a | 5.0 EE (2026-09-09) | `http://www.gameaholic.com/servers/`, `id_` replay of 20000601 (9,277 B) and 20010601 (12,645 B), plus `http://ww see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20000601id_/http://www.gameaholic.com/servers/> |
| liszt_tilenet_mailing_list_host_census | 2026-09-09, fleet 20260908T2345Z | n/a | reusable. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-09) | the smallest representative piece is one tile.net list detail page, `http://tile.net/lists/a.html` at 19971224220824, 8,446 B. | n/a | CLOSED | <http://tile.net/lists/> |
| memento_aggregator_timemaps_hostgrain | 2026-09-09, fleet 20260908T2345Z | n/a | three reusable pieces, and the third is the valuable one. see the fleet hypothesis ledger | the memento datetime in the `Link` header, machine written by the holding archive. | n/a | 0 EE (2026-09-09) | 16 registrables sampled at random from /projects/ark-data/merged260908/1999.txt, each put through one aggregator TimeMap. | n/a | CLOSED | <https://memgator.cs.odu.edu/timemap/link/<host>> |
| nsi_host_object_whois_records_hostgrain | 2026-09-09, fleet 20260908T2345Z | n/a | reusable and worth keeping. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | no artifact reached, so no domains were sampled. | n/a | CLOSED | <http://rs.internic.net/domain/> |
| orbs_open_relay_test_databases_2000_2001 | 2026-09-09, fleet 20260908T2345Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | the row's own test timestamp inside the dump, and the dumps are the "over 30 days old" partition so every row carries a test date. | n/a | 0 EE (2026-09-09) | `http://www.orbs.org/database.html`, memento 2000-03-03, 5,096 B. | n/a | CLOSED | <http://orbs.php.net/DAT/{ok,inputs,inputs.current,outputs,outputs.current,manual}.html> |
| spamcop_public_report_rows_1999_2001 | 2026-09-09, fleet 20260908T2345Z | n/a | see the fleet hypothesis ledger | the row's own two machine-written columns, "First spam dated" and "Last spam dated", e.g. | n/a | 0 EE (2026-09-09) | the smallest representative piece is ONE snapshot of the complete SpamCop statistics set, the eight pages under `/stats/` at 20000815, 48,361 B in total. | n/a | CLOSED | <https://web.archive.org/web/20000815000000id_/http://spamcop.net/stats/<page>.html> |
| ssl_server_survey_certificate_common_names | 2026-09-09, fleet 20260908T2345Z | n/a | see the fleet hypothesis ledger | for SecuritySpace, the edition directory is a machine-written stamp, `/s_survey/data/man.200007/`, and it dates every row on the page to Jul | n/a | 0 EE (2026-09-09) | the smallest representative piece is ONE monthly edition of the only host-bearing page the whole family pu see the fleet hypothesis ledger | n/a | CLOSED | <http://www.lne.com/ericm/papers/ssl_servers.html> |
| streaming_yp_directory_server_rows_1999_2001 | 2026-09-09, fleet 20260908T2345Z | n/a | see the fleet hypothesis ledger | the capture instant of the directory page, and the row's own "last seen" column. | n/a | 5.0 EE (2026-09-09) | `http://www.shoutcast.com/directory/`, `id_` replay of two in-window captures (20010401000000, 49,439 B and 20011201000000, 49,156 B). | n/a | CLOSED | <https://web.archive.org/web/20010401000000id_/http://www.shoutcast.com/directory/> |
| wayback_non_cdx_host_inventory | 2026-09-09, fleet 20260908T2345Z | n/a | reusable, and this one generalises well beyond archive.org. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the endpoint EXISTS, is not `/cdx`, and answers. | n/a | CLOSED | <https://web.archive.org/__wb/search/host?q=<registrable>> |
| web_served_zone_files_live_sweep | 2026-09-09, fleet 20260908T2345Z | n/a | the transferable rule, and it applies to a whole class of leads in the regi see the fleet hypothesis ledger | the BIND SOA serial in `YYYYMMDDnn`, or an in-file comment. | n/a | 0 EE (2026-09-09) | this lead's kill screen is "30 search operator queries plus one directory sweep, then read the three largest files WHOLE", closing "under 40 in-window files found, with the count and the per query rat | n/a | CLOSED | n/a |
...
| amprnet_ampr_org_dated_host_tables | 2026-09-09, fleet 20260908T2254Z | n/a | three reusable parts, and the first is the best thing in this file. see the fleet hypothesis ledger | nothing in window. | n/a | 0 EE (2026-09-09) | I did not need a probe: the artifact is 1.7 MB and I read it WHOLE. | n/a | FIND | <https://ftp.funet.fi/pub/ham/ftp.ucsd.edu/amprhosts> |
| banner_exchange_member_directories_1998_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | the Wayback capture timestamp, which is sound and is not why this dies. | n/a | 1.9 EE (2026-09-09) | the six largest in-window captures on the member paths of the two surviving hosts, read whole, 44,875 B: LinkExchange `/` 1997 (5,586 B) see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/19970725190136id_/http://www.linkexchange.com/members/>> |
| exposed_zone_files_soa_serial_dated | 2026-09-09, fleet 20260908T2254Z | n/a | the reusable part is a screen to run BEFORE committing to any "find the artifacts with search operators" lead: see the fleet hypothesis ledger | sound where a file exists. | n/a | 0 EE (2026-09-09) | the lead's own kill screen is "30 search results for SOA serial patterns with in-window prefixes beside `IN A` lines ... | n/a | CLOSED | <https://stuff.mit.edu/afs/sipb.mit.edu/user/bert/self-ref/debug/bar/bind/>,> |
| game_master_server_snapshot_lists_2000_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | the capture instant, container-grain. | n/a | 0 EE (2026-09-09) | three whole per-game server lists from the largest surviving in-window republisher, gameaholic.com's "Game Servers Database", 2001-06 capture see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20010601000000id_/http://www.gameaholic.com/servers/{halflife,quake3,unrealtournament}/> |
| isp_dialup_client_config_pop_hostnames | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | the archive.org item `date` field, which is real and machine-held (`2000-04-13` for supanet, `2000` for lineone and juno, `1998` for integri | n/a | 0 EE (2026-09-09) | the smallest in-window ISP install disc on archive.org, `juno40free/juno0.iso`, 45,078,528 B, read WHOLE rat see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/download/juno40free/juno0.iso>> |
| liszt_tilenet_mailing_list_host_census | 2026-09-09, fleet 20260908T2254Z | n/a | the reusable part is the test I applied instead of a see the fleet hypothesis ledger | the capture instant of a browse page, which is a page-level stamp and not a row-level one. | n/a | 0 EE (2026-09-09) | availability probe only, three TimeMaps, no page read: the arithmetic below closes it before a fetch is worth the budget, and I had ~4 minutes left when I reached it. | n/a | CLOSED | <http://www.liszt.com/> |
| memento_aggregator_timemaps_hostgrain | 2026-09-09, fleet 20260908T2254Z | n/a | reusable and cheap, and I would put it ahead o see the fleet hypothesis ledger | the Memento protocol's `datetime` attribute on each memento link would have dated each observation cleanly (RFC 7089). | n/a | 0 EE (2026-09-09) | the kill screen ("200 hosts through /timemap/link/") could not be run at all, because the aggregator does not exist. | n/a | CLOSED | <http://timetravel.mementoweb.org/timemap/link/...>> |
| mids_matrix_host_survey_result_files | 2026-09-09, fleet 20260908T2254Z | n/a | reusable. see the fleet hypothesis ledger | nothing that matters. | n/a | 0 EE (2026-09-09) | the whole in-window archived surface of all three named hosts. | n/a | CLOSED | <https://web.archive.org/web/19961111042833id_/http://www.mids.org:80/ids2/survey.2> |
| new_net_thirdlevel_hosts_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | the capture timestamp of an exact-host memento, which is website-level evidence of the kind the 0907 update requires for annual promotion. | n/a | 0 EE (2026-09-09) | see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/timemap/json?url=new.net&matchType=domain&fl=original,timestamp,statuscode&from=2001&to=2001&collapse=urlkey&limit=100000> |
| nsi_host_object_whois_records_hostgrain | 2026-09-09, fleet 20260908T2254Z | n/a | reusable, and it is the cheap half of an existence screen. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-09) | no artifact reached, so no domains were measurable. | n/a | CLOSED | <https://web.archive.org/web/19990421193716id_/http://rs.internic.net:80/domain> |
| orbs_open_relay_test_databases_2000_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | STATS carries machine-written detection windows ("new inputs detected 1 May 2000 -> 1 Jun 2000: 11751") and would have dated a dump edition | n/a | 0 EE (2026-09-09) | ORBS' own two surviving machine-written artifacts at `orbs.php.net/ see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20000530171846id_/http://orbs.php.net/DAT/inputs.current.html>> |
| proxy_pac_wpad_host_enumerations | 2026-09-09, fleet 20260908T2254Z | n/a | reusable, and it generalises well past pac files. see the fleet hypothesis ledger | nothing, because no item exists. | n/a | 0 EE (2026-09-09) | the kill screen, run at 50 URLs instead of the 2,000 it specified, because the answer arrived unanimous and a per-address rate limit is shared with two running collectors. | n/a | CLOSED | n/a |
| reopen_fleet | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | WebBase: the 2001 crawl stamp of the LAW webbase-2001 URL list (Last-Modified of the redistributed file is 2025-11-28, the crawl date is in | n/a | 0 EE (2026-09-09) | reprobe_closed.py --limit 40: 50 hosts answered, 22 unexpected 200s (statdns.com and rscott.org domain-info.1996061 see the fleet hypothesis ledger | n/a | CLOSED | <http://data.law.di.unimi.it/webdata/webbase-2001/webbase-2001.urls.gz,> |
| spamcop_public_report_rows_1999_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | see the fleet hypothesis ledger | two independent stamps, and this is the good news in the file. | n/a | 23.2 EE (2026-09-09) | the smallest representative piece is one stats page pair from the 1999-10-03 edition, `stats/most_www.html` 9,324 B and `stats/most_email.html` 8,757 B, 100 rows total. | n/a | CLOSED | <https://web.archive.org/web/19991003000948id_/http://spamcop.net:80/stats/most_www.html> |
| ssl_server_survey_certificate_common_names | 2026-09-09, fleet 20260908T2254Z | n/a | reusable, and the good part is arm A. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-09) | no host-bearing edition exists to probe, so distinct domains = 0 and both held fractions are undefined. | n/a | CLOSED | <http://www.lne.com/ericm/ssl_survey/> |
| streaming_yp_directory_server_rows_1999_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | reusable, and it is the cheap general form of the address-keyed rule. see the fleet hypothesis ledger | the capture instant only, which is container-grain and not the observation. | n/a | 0 EE (2026-09-09) | two whole SHOUTcast YP directory pages, the largest in-window captures of the directory root, read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/20010401000000id_/http://yp.shoutcast.com/> |
| fallback | 2026-09-09, fleet 20260908T2254Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-09) | agent produced no findings file | n/a | BLOCKED | n/a |
| wayback_non_cdx_host_inventory | 2026-09-09, fleet 20260908T2254Z | n/a | this is the part worth keeping, and it is the reason to file this as a result rather than a null. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-09) | the endpoint EXISTS and is genuinely not CDX. | n/a | CLOSED | <https://web.archive.org/__wb/search/host?q=<query>> |
| web_served_zone_files_live_sweep | 2026-09-09, fleet 20260908T2254Z | n/a | two reusable pieces, and the second is the reason this run was worth the hour. see the fleet hypothesis ledger | on this route it is NOT the SOA serial, and that is the finding. | n/a | 0 EE (2026-09-09) | the lead's kill screen is "30 search operator queries plus one directory sweep, then read the three largest files WHOLE ... | n/a | CLOSED | <https://stuff.mit.edu/afs/>> |
| zonefile_derived_domain_search_sites_1999_2001 | 2026-09-09, fleet 20260908T2254Z | n/a | REUSABLE AND THE REAL RESULT. see the fleet hypothesis ledger | domainsurfer stamps its own database generation on every result page, machine written, e.g. | n/a | 244 EE (2026-09-09) | the WHOLE in-window archived surface of all three named hosts, not a sample. | n/a | CLOSED | <https://web.archive.org/web/19991223102535id_/http://www.domainsurfer.com:80/ssearch.cgi?dom=%5emef> |
| amprnet_ampr_org_dated_host_tables | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and it is the cheapest kill in this run. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-08) | zero dated editions reached, so the three probe numbers are all zero: 0 distinct hosts, 0 held fraction, 0 held-and-missing-year fraction, projection 0 EE against a 21,000 EE floor. | n/a | CLOSED | <http://ftp.ucsd.edu/hamradio/packet/tcpip/hosts/> |
| banner_exchange_member_directories_1998_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | the Wayback capture timestamp, which is sound and is not why this dies. | n/a | 1.9 EE (2026-09-08) | the six largest in-window captures on the member paths of the two surviving hosts, read whole, 44,875 B: LinkExchange `/` 1997 (5,586 B) see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/19970725190136id_/http://www.linkexchange.com/members/>> |
| exposed_zone_files_soa_serial_dated | 2026-09-08, fleet 20260908T2137Z | n/a | reusable negative. see the fleet hypothesis ledger | sound in principle. | n/a | 0 EE (2026-09-08) | the discovery step could not run at the grain the hypothesis needs. | n/a | CLOSED | n/a |
| game_master_server_snapshot_lists_2000_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | the page's OWN machine-written regeneration stamp, "Active servers list last updated on: Sat Jun 14 09:22:26 EDT 1997", printed by qstat abo | n/a | 114 EE (2026-09-08) | found the real artifact via qstat.org's own `qserverpages.htm see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/19970614143210id_/http://ironman.planetquake.com/servers.html>> |
| isp_dialup_client_config_pop_hostnames | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | TWO routes, and the good one is rarer than the hypothesis assumed. | n/a | 0 EE (2026-09-08) | Smallest representative piece: 100 `.ins` files of INI format, pulled as a stride of every 5th result over the first 5 result pages of the discmaster population, 500 KiB total. | n/a | CLOSED | <https://discmaster.textfiles.com/file/<disc>/<path>.ins> |
| liszt_tilenet_mailing_list_host_census | 2026-09-08, fleet 20260908T2137Z | n/a | reusable. see the fleet hypothesis ledger | nothing per-row. | n/a | 0 EE (2026-09-08) | no new enumeration was run, because the deciding number already exists and was measured with the CURRENT screen. | n/a | CLOSED | <http://www.liszt.com/> |
| memento_aggregator_timemaps_hostgrain | 2026-09-08, fleet 20260908T2137Z | n/a | reusable negative. see the fleet hypothesis ledger | n/a. | n/a | 0 EE (2026-09-08) | the aggregator does not exist any more. | n/a | CLOSED | n/a |
| mids_matrix_host_survey_result_files | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and it generalises past MIDS to every measurement company of the period. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-08) | Smallest representative piece: `http://average.miq.net/Daily/markMM.html`, 684 B, the Internet Average daily latency result file. | n/a | CLOSED | <https://web.archive.org/web/2000id_/http://average.miq.net/Daily/markMM.html> |
| new_net_thirdlevel_hosts_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | the Wayback capture timestamp of the showcase page, 2001-10-24, which puts the named host inside 2001. | n/a | 5.0 EE (2026-09-08) | the largest in-window listing page new.net ever had captured, `www.new.net/featured_shop_site.tp` at 20011024062848, 49,491 B read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/20011024062848id_/http://www.new.net/featured_shop_site.tp>> |
| nsi_host_object_whois_records_hostgrain | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and worth keeping. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-08) | no artifact reached probe stage. | n/a | CLOSED | <http://rs.internic.net/domain/> |
| orbs_open_relay_test_databases_2000_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-08) | no domain sample was reachable to price, because the premise died first. | n/a | CLOSED | <https://web.archive.org/web/20000603161205id_/http://orbs.php.net/DAT/STATS>> |
| proxy_pac_wpad_host_enumerations | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and it generalises well past pac files. see the fleet hypothesis ledger | nothing, because no item exists. | n/a | 0 EE (2026-09-08) | the kill screen, run at 50 URLs instead of the 2,000 it specified, because the answer arrived unanimous and a per-address rate limit is shared with two running collectors. | n/a | CLOSED | n/a |
| spamcop_public_report_rows_1999_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | each ROW carries its own machine-written pair of timestamps, `First spam dated 1999-09-09 04:24:57` and `Last spam dated 1999-11-26 21:12:19 | n/a | 17.0 EE (2026-09-08) | the smallest representative piece was the whole reachable artifact, which is the point. | n/a | CLOSED | <http://www.spamcop.net/stats/{most_www,most_email,largest,biggest_whost,biggest_ehost,> |
| ssl_server_survey_certificate_common_names | 2026-09-08, fleet 20260908T2137Z | n/a | reusable. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | no result file with a host column was reachable, so the three probe numbers are all zero: 0 distinct hosts, 0 held fraction, 0 held-and-missing-year fraction, projection 0 EE against the ~11,000 EE fl | n/a | CLOSED | n/a |
| streaming_yp_directory_server_rows_1999_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | see the fleet hypothesis ledger | the capture instant plus the live "Current Statistics" line the page prints ("Listeners - 11458 Servers - 1599"), machine-written; | n/a | 0 EE (2026-09-08) | three SHOUTcast YP directory pages read whole off Wayback id_ replay (yp.shoutcast.com, 199 see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20010202160100id_/http://yp.shoutcast.com/>> |
| wayback_non_cdx_host_inventory | 2026-09-08, fleet 20260908T2137Z | n/a | THE REUSABLE PART IS THE ENDPOINT ITSELF, and it should be recorded even though it fails here. see the fleet hypothesis ledger | NOTHING. | n/a | 0 EE (2026-09-08) | 12 requests, one per registrable, against `https://web.archive.org/__wb/search/host?q=<name>`. | n/a | CLOSED | <https://web.archive.org/__wb/search/host?q=<host-or-registrable>> |
| web_served_zone_files_live_sweep | 2026-09-08, fleet 20260908T2137Z | n/a | reusable negative, identical to the SOA-serial sibling: **a live exposed-zone-file sweep is a dork-oper see the fleet hypothesis ledger | SOA serial or in-file comment inside 1996-2001, machine-written, and the hypothesis's own guard is correct: a modern Last-Modified dates the | n/a | 0 EE (2026-09-08) | same discovery blocker as exposed_zone_files_soa_serial_dated, and it is the deciding fact. | n/a | CLOSED | n/a |
| zonefile_derived_domain_search_sites_1999_2001 | 2026-09-08, fleet 20260908T2137Z | n/a | reusable, and it is a cheap generalisation of the form-endpoint law. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | The three named hosts were probed through TimeMaps and the largest reachable in-window page at each was read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/19990422034257id_/http://www.domainsurfer.com:80/> |
| banner_exchange_member_directories_1998_2001 | 2026-09-08, fleet 20260908T2014Z | n/a | see the fleet hypothesis ledger | nothing that matters here, but for completeness the pages carry a body copyright stamp (`(c) 1996-1999 LinkExchange, Inc.`) and the memento | n/a | 0 EE (2026-09-08) | The one whole directory page the kill screen asked for, read at registrable grain. | n/a | CLOSED | <https://web.archive.org/web/20000601000000id_/http://www.bcentral.com/directory/> |
| isp_dialup_client_config_pop_hostnames | 2026-09-08, fleet 20260908T2014Z | n/a | reusable, and the transferable is the facet co see the fleet hypothesis ledger | the disc's own archive.org `date` field where present (ev-1-net 2000-05, msn-setup_202210 1998, club-internet_19970418 1997-05), and on disc | n/a | 0 EE (2026-09-08) | Two probes, one per route, and the lead dies on a different number in each. | n/a | CLOSED | <https://discmaster.textfiles.com/search?q=dialup&format=ini&limit=20> |
| liszt_tilenet_mailing_list_host_census | 2026-09-08, fleet 20260908T2014Z | n/a | see the fleet hypothesis ledger | the memento datetime plus tile.net's own in-page copyright range (`Copyright 1995-1997 Walter Shelby Group Ltd`) on the 1997 edition. | n/a | 154.4 EE (2026-09-08) | the artifact turns out to have exactly one page in it that is a host census, and I read that page whole in both of its surviving editions. | n/a | CLOSED | <http://tile.net/lists/groupedby.html> |
| mids_matrix_host_survey_result_files | 2026-09-08, fleet 20260908T2014Z | n/a | the reusable part is a cheap ownership test that should run BEFORE the "read the whole result file, not its header" transferable this lead was built on. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-08) | A structural zero, decided on the artifact's OWN description before any result file was needed. | n/a | CLOSED | <https://web.archive.org/web/19990101000000id_/http://www.mids.org/> |
| nsi_host_object_whois_records_hostgrain | 2026-09-08, fleet 20260908T2014Z | n/a | reusable and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | no artifact reached, so no domains were sampled. | n/a | CLOSED | <http://rs.internic.net/domain/> |
| spamcop_public_report_rows_1999_2001 | 2026-09-08, fleet 20260908T2014Z | n/a | two reusable pieces. see the fleet hypothesis ledger | `Last updated: Saturday, 14-Oct-2000 16:03:42 EDT`, machine-written into the page by SpamCop's own generator, plus the memento datetime. | n/a | 0 EE (2026-09-08) | the smallest representative piece is one archived statistics page. | n/a | CLOSED | <http://spamcop.net/spamstats.shtml> |
| ssl_server_survey_certificate_common_names | 2026-09-08, fleet 20260908T2014Z | n/a | see the fleet hypothesis ledger | for Murray, the string `7/31/00` printed by the author at the head of each of the three pages, plus the earlier edition's own date. | n/a | 0 EE (2026-09-08) | the smallest representative piece was the whole of Eric Murray's survey, which is three HTML pages totalling 45,549 see the fleet hypothesis ledger | n/a | CLOSED | <http://www.lne.com/ericm/papers/ssl_servers.html> |
| zonefile_derived_domain_search_sites_1999_2001 | 2026-09-08, fleet 20260908T2014Z | n/a | reusable and it is the transferable part of this run. see the fleet hypothesis ledger | domainsurfer.com prints its own machine-written build stamp in the page body, `5,381,397 records / Last updated: 20 Apr. | n/a | 0 EE (2026-09-08) | No corpus page was ever reachable, so no domain sample exists to price. | n/a | CLOSED | <https://web.archive.org/web/19990422034257id_/http://www.domainsurfer.com/> |
| adblock_hosts_filter_lists_1997_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | see the fleet hypothesis ledger | a machine-written stamp inside the file. | n/a | 5434 EE (2026-09-08) | smallest representative piece = one dated release, `hosts_july9.txt` (stamp "It was last updated on July 9th, 2000"), 118,946 B, 3,027 distinct hostnames. | n/a | CLOSED | <https://web.archive.org/web/20010603004507id_/http://www.smartin-designs.com:80/downloads/hosts_127001.zip> |
| apnic_lacnic_afrinic_whois_changed_lines | 2026-09-08, fleet 20260908T2001Z | n/a | reusable, and it is the cheap half. see the fleet hypothesis ledger | nothing in APNIC or AFRINIC. | n/a | 4274 EE (2026-09-08) | the kill screen ran in full and cost 5 files. | n/a | CLOSED | <https://ftp.apnic.net/apnic/whois/apnic.db.domain.gz> |
| banner_exchange_member_directories_1998_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | see the fleet hypothesis ledger | nothing that matters here, but for completeness the pages carry a body copyright stamp (`(c) 1996-1999 LinkExchange, Inc.`) and the memento | n/a | 0 EE (2026-09-08) | The one whole directory page the kill screen asked for, read at registrable grain. | n/a | CLOSED | <https://web.archive.org/web/20000601000000id_/http://www.bcentral.com/directory/> |
| censorware_decrypted_blocklist_files_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | reusable, and it is the cheap kill for any "the report is prose, the underlying FILE is the artifact" re-proposal: before harvesting, ask see the fleet hypothesis ledger | the report page's own byline date (e.g. | n/a | 2.95 EE (2026-09-08) | the whole published surface of the family, not a sample. | n/a | CLOSED | <https://web.archive.org/web/20010601000000id_/http://www.peacefire.org/censorware/<vendor>/> |
| extreme_tracking_public_member_reports_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | two reusable pieces, and the second is a correction worth having. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | the hypothesis rests on two claims, "eXTReMe made reports public by default" and "nedstat.com and thecounter.com published browsable indexes of participating sites". | n/a | CLOSED | <http://www.extreme-dm.com/> |
| isp_dialup_client_config_pop_hostnames | 2026-09-08, fleet 20260908T2001Z | n/a | reusable, and the transferable is the facet co see the fleet hypothesis ledger | the disc's own archive.org `date` field where present (ev-1-net 2000-05, msn-setup_202210 1998, club-internet_19970418 1997-05), and on disc | n/a | 0 EE (2026-09-08) | Two probes, one per route, and the lead dies on a different number in each. | n/a | CLOSED | <https://discmaster.textfiles.com/search?q=dialup&format=ini&limit=20> |
| mids_matrix_host_survey_result_files | 2026-09-08, fleet 20260908T2001Z | n/a | the reusable part is a cheap ownership test that should run BEFORE the "read the whole result file, not its header" transferable this lead was built on. see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-08) | A structural zero, decided on the artifact's OWN description before any result file was needed. | n/a | CLOSED | <https://web.archive.org/web/19990101000000id_/http://www.mids.org/> |
| period_stats_report_trees_live_hosts | 2026-09-08, fleet 20260908T2001Z | n/a | see the fleet hypothesis ledger | "Program started at Mon-17-Feb-1997 17:19 local time" plus the data-range line, both machine written by Analog itself. | n/a | 0 EE (2026-09-08) | one live in-window report tree, `scholar.lib.vt.edu/www_stats/borg/` (Virginia Tech Scholarly Communications), index 2,035 B listing 30 report targets. | n/a | CLOSED | <https://scholar.lib.vt.edu/www_stats/borg/jte.html> |
| search_query_log_url_tokens_1997_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | reusable and cheap. see the fleet hypothesis ledger | sound in principle and this is the part worth keeping. | n/a | 0 EE (2026-09-08) | no probe was possible, and establishing that took four requests. | n/a | BLOCKED | <https://web.archive.org/web/2010id_/http://ist.psu.edu/faculty_pages/jjansen/academic/transaction_logs.html> |
| v3_redirect_service_target_tables_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | reusable, and it is a cheap generalisation of the availability oracle now that CDX is off limits. see the fleet hypothesis ledger | nothing. | n/a | 25 EE (2026-09-08) | the kill screen the hypothesis wrote for itself is exactly what fired. | n/a | CLOSED | <http://www.v3.com/> |
| zonefile_derived_domain_search_sites_1999_2001 | 2026-09-08, fleet 20260908T2001Z | n/a | reusable and it is the transferable part of this run. see the fleet hypothesis ledger | domainsurfer.com prints its own machine-written build stamp in the page body, `5,381,397 records / Last updated: 20 Apr. | n/a | 0 EE (2026-09-08) | No corpus page was ever reachable, so no domain sample exists to price. | n/a | CLOSED | <https://web.archive.org/web/19990422034257id_/http://www.domainsurfer.com/> |
| adblock_hosts_filter_lists_1997_2001 | 2026-09-08, fleet 20260908T1819Z | n/a | see the fleet hypothesis ledger | a machine-written stamp inside the file. | n/a | 5434 EE (2026-09-08) | smallest representative piece = one dated release, `hosts_july9.txt` (stamp "It was last updated on July 9th, 2000"), 118,946 B, 3,027 distinct hostnames. | n/a | CLOSED | <https://web.archive.org/web/20010603004507id_/http://www.smartin-designs.com:80/downloads/hosts_127001.zip> |
| apnic_lacnic_afrinic_whois_changed_lines | 2026-09-08, fleet 20260908T1819Z | n/a | reusable, and it is the cheap half. see the fleet hypothesis ledger | nothing in APNIC or AFRINIC. | n/a | 4274 EE (2026-09-08) | the kill screen ran in full and cost 5 files. | n/a | CLOSED | <https://ftp.apnic.net/apnic/whois/apnic.db.domain.gz> |
| censorware_decrypted_blocklist_files_2001 | 2026-09-08, fleet 20260908T1819Z | n/a | reusable, and it is the cheap kill for any "the report is prose, the underlying FILE is the artifact" re-proposal: before harvesting, ask see the fleet hypothesis ledger | the report page's own byline date (e.g. | n/a | 2.95 EE (2026-09-08) | the whole published surface of the family, not a sample. | n/a | CLOSED | <https://web.archive.org/web/20010601000000id_/http://www.peacefire.org/censorware/<vendor>/> |
| extreme_tracking_public_member_reports_2001 | 2026-09-08, fleet 20260908T1819Z | n/a | two reusable pieces, and the second is a correction worth having. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | the hypothesis rests on two claims, "eXTReMe made reports public by default" and "nedstat.com and thecounter.com published browsable indexes of participating sites". | n/a | CLOSED | <http://www.extreme-dm.com/> |
| period_stats_report_trees_live_hosts | 2026-09-08, fleet 20260908T1819Z | n/a | see the fleet hypothesis ledger | "Program started at Mon-17-Feb-1997 17:19 local time" plus the data-range line, both machine written by Analog itself. | n/a | 0 EE (2026-09-08) | one live in-window report tree, `scholar.lib.vt.edu/www_stats/borg/` (Virginia Tech Scholarly Communications), index 2,035 B listing 30 report targets. | n/a | CLOSED | <https://scholar.lib.vt.edu/www_stats/borg/jte.html> |
| search_query_log_url_tokens_1997_2001 | 2026-09-08, fleet 20260908T1819Z | n/a | reusable and cheap. see the fleet hypothesis ledger | sound in principle and this is the part worth keeping. | n/a | 0 EE (2026-09-08) | no probe was possible, and establishing that took four requests. | n/a | BLOCKED | <https://web.archive.org/web/2010id_/http://ist.psu.edu/faculty_pages/jjansen/academic/transaction_logs.html> |
| v3_redirect_service_target_tables_2001 | 2026-09-08, fleet 20260908T1819Z | n/a | reusable, and it is a cheap generalisation of the availability oracle now that CDX is off limits. see the fleet hypothesis ledger | nothing. | n/a | 25 EE (2026-09-08) | the kill screen the hypothesis wrote for itself is exactly what fired. | n/a | CLOSED | <http://www.v3.com/> |
| bookmark_service_public_lists_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | the server-written date added, and it demonstrably exists: the member-folder table on the same page offers `Sort: Alphabetically \| By Hits \| | n/a | 0 EE (2026-09-08) | the smallest representative piece is ONE blink.c see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20010606150929/http://www.blink.com:80/go?page=Public&args=3&arg0=dir&arg1=0&arg2=2>> |
| centralnic_thirdlevel_registry_1996_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | the pattern is the deliverable, and it is the same law from three directions. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | the hypothesis's own kill screen was explicit - "the bulk NAME LIST is the whole problem, so screen for it first and spend nothing else" - and it fired on the first artifact. | n/a | CLOSED | <https://web.archive.org/web/2001id_/http://www.centralnic.com> |
| distributed_net_participant_mail_domains | 2026-09-08, fleet 20260908T1706Z | n/a | reusable, and short. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-08) | no probe was permissible. | n/a | BLOCKED | <https://stats.distributed.net/robots.txt>> |
| dns_client_trace_qnames_2000_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | reusable, and this is the part I would keep. see the fleet hypothesis ledger | the capture second on the packet, which is exactly the right kind of stamp and is the reason this lead was worth an hour. | n/a | 0 EE (2026-09-08) | no records exist to probe. | n/a | CLOSED | <https://web.archive.org/web/timemap/link/http://nms.lcs.mit.edu/dns/>> |
| edgar_full_index_whole_corpus_hostgrain | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | `Date Filed` in `full-index/<year>/QTR<n>/form.idx`, plus the accession number's own year digits, both machine-written by EDGAR at acceptanc | n/a | 1.47 EE (2026-09-08) | **236 filings, 68.7 MB, four partitions priced separately, and three of the four returned see the fleet hypothesis ledger | n/a | CLOSED | <https://www.sec.gov/Archives/edgar/full-index/2001/QTR1/form.idx> |
| fidonet_nodelist_internet_flags | 2026-09-08, fleet 20260908T1706Z | n/a | three reusable pieces. see the fleet hypothesis ledger | the edition's own machine-written first line, `;A FidoNet Nodelist for Friday, January 1, 1999 -- Day number 001 : 11353`, written by the co | n/a | 2500 EE (2026-09-08) | 8 editions downloaded, 13.1 MB total, 8 requests. | n/a | CLOSED | <https://nodelist.fidonet.cc/> |
| freshmeat_backend_rdf_daily_editions | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | the Apache directory index at `/backend/` is a machine-written stamp and dates each backend file to the minute (`fm-projects.rdf 25-Dec-2001 | n/a | 0 EE (2026-09-08) | `http://freshmeat.net/backend/oneweek_alphabetical.html` @ 20010831003036, read WHOLE see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20011225125454id_/http://freshmeat.net/backend/> |
| ftp_index_remaining_engines | 2026-09-08, fleet 20260908T1706Z | n/a | reusable, and it is the part worth keeping. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | no inventory artifact exists to probe on any of the four unreached engines, so there were no domains to count. | n/a | CLOSED | <https://web.archive.org/web/19990429010725id_/http://ftpsearch.lycos.com/search-info/search.html>> |
| harvested_address_list_domains_1999_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | reusable, and it is a cheap general screen. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | archive.org item search only, zero CDX, as the kill screen specified. | n/a | CLOSED | <https://archive.org/advancedsearch.php?q=...&output=json> |
| internic_zone_surviving_ftp_mirrors | 2026-09-08, fleet 20260908T1706Z | n/a | two reusable pieces. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | directory listings only, no payload downloads, exactly as the kill screen specified. | n/a | CLOSED | <https://ftp.uni-erlangen.de/pub/ripe.net/ls-lR.gz> |
| irc_network_server_history_netsplit | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | the page's own header, `Below you can see a snapshot of the statistics from 1998-10-13` plus the generator's line `created at: 12.10.98 18:3 | n/a | 51.9 EE (2026-09-08) | the whole reachable artifact was read, so there is no extrapolation. | n/a | CLOSED | <https://web.archive.org/web/20030312142501id_/http://irc.netsplit.de/networks.19981013/> |
| looksmart_zeal_bulk_directory_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | reusable. see the fleet hypothesis ledger | the hypothesis proposed zeal.com's per-listing dates. | n/a | 0 EE (2026-09-08) | `http://www.looksmart.com/` @2001, read WHOLE, 18,865 B, title "LookSmart": ZERO `href` attributes in the entire document and 2 external hostnames (www.msn.com, www.netscape.com). | n/a | CLOSED | n/a |
| novelty_cctld_bulk_registration_lists_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | the capture datetime of a registry-served list page (the auction list is machine-generated from the registry's own live inventory, so the me | n/a | 725 EE (2026-09-08) | `http://www.nic.nu/auction/auctionlist.cfm` @ 20010604-20011218, o see the fleet hypothesis ledger | n/a | CLOSED | <http://web.archive.org/web/20010604023025id_/http://www.nic.nu/auction/auctionlist.cfm> |
| reopen_fleet | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | WebBase: the crawl itself, Stanford WebBase 2001 (LAW dataset stamp), one date per corpus, class link_source; | n/a | 5699.3 EE (2026-09-08) | WebBase: streamed the whole webbase-2001.urls.gz (720,229,219 B, 118,142,155 URLs) from data.law.di.unimi.it (robots.txt: Allow: /), kept only see the fleet hypothesis ledger | n/a | FIND | <http://data.law.di.unimi.it/webdata/webbase-2001/webbase-2001.urls.gz,> |
| rfc_ignorant_name_keyed_zones_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | reusable, and it is the cheapest kill in th see the fleet hypothesis ledger | nothing usable. | n/a | 0 EE (2026-09-08) | the operator's own machine-written counter, on the ONE in-window capture of the site, caps the entire population at 3,876 listed domains across all four name-keyed zones as of 2001-09-26: dsn 1,237, p | n/a | CLOSED | <https://web.archive.org/web/20010926202156id_/http://www.rfc-ignorant.org/>> |
| sourceforge_subdomain_inventory_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | `Register Date: <B>2001-07-24 02:24</B>`, printed by SourceForge's own PHP from the project table, per row, in the row itself. | n/a | 4300 EE (2026-09-08) | 4 replayed `softwaremap/trove_list.php` pages, 80 project rows, 76 distinct `<unixname>.so see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20010801143411id_/http://sourceforge.net/softwaremap/> |
| spamarchive_bulk_messages_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | reusable. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-08) | the kill screen's first step is "item search plus ONE part file". | n/a | CLOSED | <https://archive.org/advancedsearch.php?q=spamarchive&output=json>> |
| udrp_nonwipo_provider_dockets_2000_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | see the fleet hypothesis ledger | the "Date Commenced" column, a machine-kept docket date on a row that also carries the disputed name verbatim. | n/a | 0 EE (2026-09-08) | no probe was needed and none was taken, because the artifact turned out to be ONE 3.28 MB file covering ALL SIX providers at once, so it was read WHOLE per rule 5. | n/a | CLOSED | <https://www.icann.org/udrp/proceedings-list.htm,> |
| wap_directory_hostnames_2001 | 2026-09-08, fleet 20260908T1706Z | n/a | the reusable result is bigger than this lead. see the fleet hypothesis ledger | nothing new. | n/a | 0 EE (2026-09-08) | BOTH routes probed, both fail, and route B fails with a clean measured rate. | n/a | CLOSED | n/a |
| fallback | 2026-09-08, fleet 20260908T1706Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-08) | agent produced no findings file | n/a | BLOCKED | n/a |
| archiveorg_item_store_zone_dumps | 2026-09-08, fleet 20260908T1344Z | n/a | reusable, and cheap enough to run before any item-store hypothesis. see the fleet hypothesis ledger | nothing in this shelf. | n/a | 0 EE (2026-09-08) | no probe bytes were needed and none were fetched: the kill screen was the search and metadata APIs alone, and it fired. | n/a | CLOSED | n/a |
| censorware_vendor_lists_2001 | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | a Peacefire/censorware.org report page carries its own publication date and its rows are hosts a vendor's classifier had categorised at that | n/a | 1.33 EE (2026-09-08) | ten in-window (2001-11 replay) censorware report pages at peacefire.org (X-Stop, SmartFilter, BESS, CYBERsitter, Cyber_Patrol, N see the fleet hypothesis ledger | n/a | CLOSED | <http://www.squidguard.org/blacklist/>> |
| defacement_mirrors_beyond_attrition_2001 | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | each row carries a `DD/MM/YYYY` defacement date and a machine-built mirror path `http://defaced.alldas.de/mirror/2001/07/01/<host>/`, so the | n/a | 42 EE (2026-09-08) | the one in-window alldas month listing that exists, `?archives=cur see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20011204182953id_/http://defaced.alldas.de/?archives=complete> |
| fidonet_nodelist_internet_flags | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | the nodelist edition's own Julian-day filename and date, written by the coordinators' compiler and reproduced verbatim by nodehist (`16 Apr | n/a | 0 EE (2026-09-08) | the artifact EXISTS, is machine-generated, self-dates to the day, and covers the whole window, and it is unreachable in bulk. | n/a | BLOCKED | <https://nodehist.fidonet.org.ua/?address=2%3A463%2F68>,> |
| ftp_index_remaining_engines | 2026-09-08, fleet 20260908T1344Z | n/a | reusable, and two parts of it are cheap. see the fleet hypothesis ledger | nothing. | n/a | 5.47 EE (2026-09-08) | the best page on the only one of the four engines that is both captured in-window and carries an inventory. | n/a | CLOSED | <https://web.archive.org/web/2001id_/http://www.filesearching.com/top100.html>> |
| ftp_sites_list_monthly_editions | 2026-09-08, fleet 20260908T1344Z | n/a | reusable, and the transferable lesson is about editions, not ab see the fleet hypothesis ledger | the Usenet posting header the mirror preserves verbatim, and it dates ONE edition, not seventy-two. | n/a | 584.73 EE (2026-09-08) | no sampling was needed: the artifact is 1.65 MB, so all 23 parts were fetched and read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/20010714184958id_/http://www.landfield.com/faqs/> |
| irc_network_server_history_netsplit | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | the snapshot's own machine-written stamp, `created at: 12.10.98 18:31:48 MET` (with `compared to: 11.10.98 18:36:49 MET`), printed by the ge | n/a | 0 EE (2026-09-08) | TWO probes, because the hypothesis died and a different artifact on the same host survived. | n/a | CLOSED | <https://web.archive.org/web/20021231224601id_/http://irc.netsplit.de/networks.19981013/>> |
| new_gtld_2001_launch_populations | 2026-09-08, fleet 20260908T1344Z | n/a | reusable. see the fleet hypothesis ledger | nothing retrievable. | n/a | 0 EE (2026-09-08) | the held-set count itself is the cheapest probe here and it confirms the premise: /projects/ark-data/merged260908/2001.txt holds 22,210 `.info` and 1,196 `.biz` names for 2001, and /projects/ark-data/ | n/a | CLOSED | <https://web.archive.org/web/20011025074237id_/http://www.nic.info/> |
| reopen_fleet | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | for WebBase 2001, nothing machine-written inside the artifact: webbase-2001.properties is stamped `#Wed Nov 17 23:31:09 CET 2010` (the BVGra | n/a | 5722 EE (2026-09-08) | reprobe_closed.py --limit 40: 40 URLs re-asked, 8 answer 200 unexpectedly but every one is a host HOMEPAGE name see the fleet hypothesis ledger | n/a | CLOSED | <http://data.law.di.unimi.it/webdata/webbase-2001/webbase-2001.urls.gz,> |
| sourceforge_subdomain_inventory_2001 | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | the Wayback capture instant of the softwaremap listing page, which displays the project as listed by the platform at that instant (the FFA-p | n/a | 0 EE (2026-09-08) | smallest representative piece = one softwaremap leaf see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20011102071050id_/http://sourceforge.net/softwaremap/trove_list.php?form_cat=20>> |
| ukwa_host_linkage_remaining_bytes | 2026-09-08, fleet 20260908T1344Z | n/a | see the fleet hypothesis ledger | field 1 of every row, the crawl year written by the archive's own link-graph extractor, not asserted by a person. | n/a | 134.57 EE (2026-09-08) | 1,048,576 compressed bytes from offset 0 of the 20,928,588,915 see the fleet hypothesis ledger | n/a | CLOSED | <https://web.archive.org/web/20200106181208id_/https://www.webarchive.org.uk/datasets/ukwa.ds.2/linkage/host-linkage.tsv.gz>> |
| archiveorg_item_store_zone_dumps | 2026-09-08, fleet 20260908T1258Z | n/a | reusable, and cheap enough to run before any item-store hypothesis. see the fleet hypothesis ledger | nothing in this shelf. | n/a | 0 EE (2026-09-08) | no probe bytes were needed and none were fetched: the kill screen was the search and metadata APIs alone, and it fired. | n/a | CLOSED | n/a |
| censorware_vendor_lists_2001 | 2026-09-08, fleet 20260908T1258Z | n/a | see the fleet hypothesis ledger | a Peacefire/censorware.org report page carries its own publication date and its rows are hosts a vendor's classifier had categorised at that | n/a | 1.33 EE (2026-09-08) | ten in-window (2001-11 replay) censorware report pages at peacefire.org (X-Stop, SmartFilter, BESS, CYBERsitter, Cyber_Patrol, N see the fleet hypothesis ledger | n/a | CLOSED | <http://www.squidguard.org/blacklist/>> |
| defacement_mirrors_beyond_attrition_2001 | 2026-09-08, fleet 20260908T1258Z | n/a | reusable. see the fleet hypothesis ledger | the mirror URL the row links to, `/mirror/2001/11/04/www.tomapps.com/`, which is written by the mirroring script and carries year, month, da | n/a | 207 EE (2026-09-08) | defaced.alldas.de, November 2001 read as completely as Wayback holds it. | n/a | CLOSED | <http://defaced.alldas.de/?archives=complete> |
| freedns_thirdlevel_host_indexes | 2026-09-08, fleet 20260908T1258Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | two independent probes, and each one closes the class on its own. | n/a | CLOSED | <https://web.archive.org/web/19970413023415id_/http://www.ml.org/>> |
| ftp_index_server_inventories | 2026-09-08, fleet 20260908T1258Z | n/a | reusable, and the useful part of this run. see the fleet hypothesis ledger | the row itself. | n/a | 4786 EE (2026-09-08) | FAST/Tor Egge FTP Search's own server inventory `ftpsearch.ntnu.no/search-info/ftpsites.bydomain.html`, the largest real capture (1998-04-22, 537,838 B) = 7,017 rows, 6,947 distinct FQDNs, all carryin | n/a | CLOSED | <http://ftpsearch.ntnu.no/search-info/ftpsites.bydomain.html> |
| ftp_sites_list_monthly_editions | 2026-09-08, fleet 20260908T1258Z | n/a | reusable, and the transferable lesson is about editions, not ab see the fleet hypothesis ledger | the Usenet posting header the mirror preserves verbatim, and it dates ONE edition, not seventy-two. | n/a | 584.73 EE (2026-09-08) | no sampling was needed: the artifact is 1.65 MB, so all 23 parts were fetched and read WHOLE. | n/a | CLOSED | <https://web.archive.org/web/20010714184958id_/http://www.landfield.com/faqs/> |
| new_gtld_2001_launch_populations | 2026-09-08, fleet 20260908T1258Z | n/a | reusable. see the fleet hypothesis ledger | nothing was retrieved to date. | n/a | 0 EE (2026-09-08) | no bulk artifact was found to probe, so no held fraction could be measured. | n/a | CLOSED | n/a |
| odp_period_rdf_dump_replay | 2026-09-08, fleet 20260908T1258Z | n/a | reusable and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | no probe was possible. | n/a | CLOSED | <http://dmoz.org:80/rdf/content.rdf.u8.gz> |
...
| ukwa_host_linkage_remaining_bytes | 2026-09-08, fleet 20260908T1258Z | n/a | three reusable pieces, in order of value. see the fleet hypothesis ledger | field 1 of each row, the crawl year written by the archive's link-graph extractor. | n/a | 0 EE (2026-09-08) | the kill screen was overtaken by a structural fact found on the first inflate. | n/a | CLOSED | <https://web.archive.org/web/20200106181208id_/https://www.webarchive.org.uk/datasets/ukwa.ds.2/linkage/host-linkage.tsv.gz> |
| freedns_thirdlevel_host_indexes | 2026-09-08, fleet 20260908T1141Z | n/a | reusable, and cheap. see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-08) | two independent probes, and each one closes the class on its own. | n/a | CLOSED | <https://web.archive.org/web/19970413023415id_/http://www.ml.org/>> |
| ftp_index_server_inventories | 2026-09-08, fleet 20260908T1141Z | n/a | reusable, and the unblock that mattered. see the fleet hypothesis ledger | each row carries the engine's own crawl completion stamp beside the host, e.g. | n/a | 4786.3 EE (2026-09-08) | smallest representative piece = one page, `ftpsites.bydomain.html` captured 1998-04-22 (537,838 bytes). | n/a | FIND | <http://ftpsearch.ntnu.no/search-info/dataset-info.html> |
| odp_period_rdf_dump_replay | 2026-09-08, fleet 20260908T1141Z | n/a | Reusable and cheap. see the fleet hypothesis ledger | nothing reachable. | n/a | 0 EE (2026-09-08) | The kill screen's own first step, run on TimeMaps only (CDX untouched): 12 URL forms of the ODP dump and its entry points. | n/a | CLOSED | <http://dmoz.org/rdf/content.rdf.u8.gz> |
| registry_drop_lists_daily_2001 | 2026-09-21, laptop | 2000 | `unclaimeddomains.com/freesample.html`, two in-window Wayback captures (20000815, 20000929), 4,067 com/net/org names the page says "just expired" | the capture stamp; candidate-only, no year claimed | n/a | fleet 1,870.8 EE candidate (2026-09-21); seeded as CANDIDATES 2026-09-21 | n/a | 2 requests | SEEDED (candidate) | <https://web.archive.org/web/20000815082336id_/http://www.unclaimeddomains.com/freesample.html> |
| ftp_index_server_inventories | 2026-09-08, fleet 20260908T1110Z | n/a | reusable, and the unblock that mattered. see the fleet hypothesis ledger | each row carries the engine's own crawl completion stamp beside the host, e.g. | n/a | 4786.3 EE (2026-09-08) | smallest representative piece = one page, `ftpsites.bydomain.html` captured 1998-04-22 (537,838 bytes). | n/a | FIND | <http://ftpsearch.ntnu.no/search-info/dataset-info.html> |
| registry_drop_lists_daily_2001 | 2026-09-21, laptop | 2000 | `unclaimeddomains.com/freesample.html`, two in-window Wayback captures (20000815, 20000929), 4,067 com/net/org names the page says "just expired" | the capture stamp; candidate-only, no year claimed | n/a | fleet 1,870.8 EE candidate (2026-09-21); seeded as CANDIDATES 2026-09-21 | n/a | 2 requests | SEEDED (candidate) | <https://web.archive.org/web/20000815082336id_/http://www.unclaimeddomains.com/freesample.html> |
| blog_platform_recently_updated_rosters | 2026-09-08, fleet 20260908T0635Z | n/a | see the fleet hypothesis ledger | the wayback capture timestamp of the roster page. | n/a | 31.6 EE (2026-09-08) | 6 wayback REPLAY captures (no CDX touched), 82,096 B total: blogger.com front page 2001-03-01, manilasites.com 2001-02-04, weblogger.com 2000-06-11, editthispage.com 2000-08-15, userland.com/updates 2 | n/a | CLOSED | <https://web.archive.org/web/<ts>/http://www.blogger.com/> |
| blogroll_outlinks_id_replay_2001 | 2026-09-08, fleet 20260908T0635Z | n/a | reusable. see the fleet hypothesis ledger | the capture year of the page carrying the href, as `link_source` under the | n/a | 2.05 EE (2026-09-08) | The kill screen's first half could not be run and its second half kills the lens outright. | n/a | CLOSED | <https://web.archive.org/web/{ts}id_/http://{host}/>:> |
| gnu_mbox_received_chains_hostgrain | 2026-09-08, fleet 20260908T0635Z | n/a | reusable, and the cheap part is the order. see the fleet hypothesis ledger | nothing was read. | n/a | 0 EE (2026-09-08) | the kill screen's own step 1 (the terms page) fired before any mbox byte. | n/a | BLOCKED | <https://lists.gnu.org/archive/mbox/bug-gnu-emacs/2001-03> |
...
| nntp_list_gateways_perl_php | 2026-09-08, fleet 20260908T0635Z | n/a | reusable, and the cheap half is worth keeping. see the fleet hypothesis ledger | the RFC 822 `Date:` header of the article, served verbatim by the gateway and echoed in the XOVER overview line, so every hostname pasted in | n/a | 90.2 EE (2026-09-08) | 5,250 ARTICLE bodies, evenly strided across the in-window range of 12 groups on the two hosts (5,239 of them parsed to a 1996-2001 Date). | n/a | CLOSED | n/a |
| registrar_expiring_lists_beyond_namewinner | 2026-09-08, fleet 20260908T0635Z | n/a | reusable and it cost no CDX. see the fleet hypothesis ledger | on dnsresearch.com's on-hold page a machine-printed heading over each sample | n/a | 364.6 EE (2026-09-08) | The enumeration half was run for zero network requests off the Usenet corpus that another | n/a | CLOSED | <https://web.archive.org/web/20001204210500id_/http://www.dnsresearch.com/onhold.htm>> |
| reopen_fleet | 2026-09-08, fleet 20260908T0635Z | n/a | reprobe_closed.py flags availability only. see the fleet hypothesis ledger | n/a, no artifact repriced this run | n/a | 0 EE (2026-09-08) | uv run python scripts/harness/reprobe_closed.py --limit 40, foreground, no web.archive.org/cdx touched. | n/a | CLOSED | n/a |
| fallback | 2026-09-08, fleet 20260908T0635Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-08) | agent produced no findings file | n/a | BLOCKED | n/a |
| dns_hostname_web_bridge | 2026-09-07, fleet 20260907T1056Z | n/a | reusable, and it generalises past this slug. see the fleet hypothesis ledger | the ISC / Network Wizards survey edition stamp, which dates a DNS observation of that exact host. | n/a | 0 EE (2026-09-07) | no fetch and no SQL pass was possible or needed: the reviewer ran this exact probe himself and the numbers are already in the repo. | n/a | CLOSED | n/a |
| egroups_bodies_hostgrain | 2026-09-07, fleet 20260907T1056Z | n/a | see the fleet hypothesis ledger | each message's own `Date:` header, intrinsic to the artifact and not recovered from a crawl, read by `ark.usenet.message_year`, exactly as t | n/a | 37.83 EE (2026-09-07) | TWO probes, because the named artifact is unreachable and the hypothesis na see the fleet hypothesis ledger | n/a | BLOCKED | <https://archive.org/download/yahoo-groups-2017-05-28T12-49-04Z-33ceb8/4-avuh.1uHXvA8.warc.gz> |
| encoded_bodies_container_sweep | 2026-09-07, fleet 20260907T1056Z | n/a | see the fleet hypothesis ledger | the message's own machine-written `Date:` header, parsed by | n/a | 0 EE (2026-09-07) | one archive, `alt.make.money.fast.mbox.zip`, 202,829,533 B compressed and 754,661,843 B encoded share of in-window messages : 7,906 flagged (3.49%), 6,942 decoded to non-empty readable text (3.06%). | n/a | CLOSED | <https://archive.org/download/usenet-alt/alt.make.money.fast.mbox.zip>,> |
| hostname_journal_ingest_completeness_audit | 2026-09-07, fleet 20260907T1056Z | n/a | two audits that need nothing but the raw tree and run in under three minutes, worth keeping as a standing check on any collector that writes journals and ledg see the fleet hypothesis ledger | the 14-digit capture stamp on each journal row (the journals are CDX hostname sweeps). | n/a | 0 EE (2026-09-07) | the artifact is on disk, so the whole ledger side was read rather than sampled. | n/a | BLOCKED | n/a |
...
| hostname_reject_residue_normalization | 2026-09-07, fleet 20260907T1056Z | n/a | reusable, and the reusable part is the class histogram rather than the recovery. see the fleet hypothesis ledger | nothing new. | n/a | 18.3 EE (2026-09-07) | the hypothesis's own kill screen was "count the rejects and break them down by class". | n/a | CLOSED | <https://web.archive.org/web/20200106181208id_/https://www.webarchive.org.uk/datasets/ukwa.ds.2/linkage/host-linkage.tsv.gz> |
| ia_derivative_deposits_hostname_grain | 2026-09-07, fleet 20260907T1056Z | n/a | see the fleet hypothesis ledger | field 1, the crawl year UKWA wrote | n/a | 11.5 EE (2026-09-23) | exact host-years vs merged260922, comm and DuckDB agree: www./deeper targets 10 of 917,057 absent, sources 4 of 480,494, all malformed | n/a | CLOSED | <https://web.archive.org/web/20200106181208id_/https://www.webarchive.org.uk/datasets/ukwa.ds.2/linkage/host-linkage.tsv.gz> |
| archiveorg_in_window_web_items_alexa_inktomi | 2026-09-22 | 1996-2001 | archive.org item search | the item's own crawl-span description, e.g. Crawldata from Alexa Internet from 22 Dec 1996 to 25 Dec 1996 | n/a | 0 EE (2026-09-22) | CLOSED on access. `mediatype:web AND year:[1996 TO 2001]` returns 2,223 Alexa and Inktomi deposits, each with a ~97 MB Item CDX Index, the shape that paid 50,722 EE; every file is `private=true`. | n/a | CLOSED | <https://archive.org/metadata/IA-005549-c> |
| isc_ship_credit_check | 2026-09-07, fleet 20260907T1056Z | n/a | when a lane's value depends on whether the reviewer credits a UNIT rather than a source, read his ruling register before pricing the artifact, and confirm the ruling was APPLIED by differencing his release table on the one axis the shipment is confin see the fleet hypothesis ledger | nothing. | n/a | 0 EE (2026-09-07) | no fetch and no sample were needed: the question was already answered in writing by the | n/a | CLOSED | n/a |
| reopen_fleet | 2026-09-07, fleet 20260907T1056Z | n/a | n/a | the zone's own SOA serial, line 8 of the file, `1999112000 ;serial`, which is machine-written by the registry and matches the publisher's fi | n/a | 5048.12 EE (2026-09-07) | `rscott.org/OldInternetFiles/` re-answered 200 in the availability re-probe. | n/a | FIND | <https://rscott.org/OldInternetFiles/edu.19991120.zone> |
| fallback | 2026-09-07, fleet 20260907T1056Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-07) | agent produced no findings file | n/a | BLOCKED | n/a |
...
| fidonet_echomail_bodies_hostgrain | 2026-09-04, fleet 20260904T1544Z | n/a | see the fleet hypothesis ledger | the per-message header `Ref: F3K00011 Date: 03/13/98`, written by the BBS message-board software and preserved verbatim by the scrape, with | n/a | 3.2 EE (2026-09-04) | 26,214,400 bytes, a Range request on the head of `scraped-co see the fleet hypothesis ledger | n/a | CLOSED | <https://archive.org/download/fidonet_combined_execpc_starfleet_messages_1995_1999/scraped-combined.txt> |
| inaddr_reverse_zones_2000_2001 | 2026-09-04, fleet 20260904T1544Z | n/a | reusable. see the fleet hypothesis ledger | nothing, because no in-window artifact was found. | n/a | 0 EE (2026-09-04) | The hypothesis' own kill screen was existence, so nothing was measured and | n/a | CLOSED | <https://ftp.apnic.net/apnic/arin/> |
| irr_nonrir_changed_lines | 2026-09-04, fleet 20260904T1544Z | n/a | reusable and cheap. Any registry dump that carries a per-field edit date can be | the RPSL `changed:` attribute, `changed: <mailbox> YYYYMMDD`, written | n/a | 31.56 EE (2026-09-04) | the whole of RADB, because the whole of RADB is 25,482,729 B and streaming it was | n/a | CLOSED | n/a |
| isc_survey_host_files_remaining_tlds | 2026-09-04, fleet 20260904T1544Z | n/a | reusable, and the reusable part is the ROUTE, not the source. Build the Wayback | the survey month encoded in the artifact's own published path, | n/a | ~1,400 EE (2026-09-20) | com.gz 22M and edu.gz 13M never captured, 9607 and 9701 both 404; the other 178 files are in the store at 0.03% net-new | n/a | CLOSED | <http://web.archive.org/web/1997id_/http://nw.com:80/zone/{9607,9701}.hosts/<tld>.gz> |
| list_archive_engine_monthly_bulk | 2026-09-04, fleet 20260904T1544Z | n/a | reusable, and the transferable part is the correction, n see the fleet hypothesis ledger | the per-message `Date:` header written by the sender's MUA, corroborated by the engine's own machine-written filename `<list>/<YYYY>-<Month> | n/a | 76 EE (2026-09-04) | 15 in-window pipermail month files from mail.python.org (python-list 1999-07, 2000-03, 2001-06, 2001-12; | n/a | CLOSED | <https://mail.python.org/pipermail/> |
...
| nanog_namedroppers_pasted_fqdns | 2026-09-04, fleet 20260904T1544Z | n/a | reusable, see the fleet hypothesis ledger | the message's own `Date:` header, parsed with | n/a | 67 EE (2026-09-04) | Three monthly mbox files from the IETF's own bulk mail archive, the only arm \| distinct hosts \| held \| net-new hosts \| net-new host EE \| net-new reg EE pasted \| 62 \| 3 \| 59 \| 29.3 \| 0.0 prose \| 123 \| | n/a | CLOSED | <https://www.ietf.org/ietf-ftp/ietf-mail-archive/<list>/<YYYY-MM>.mail> |
| fallback | 2026-09-04, fleet 20260904T1544Z | n/a | n/a | n/a | n/a | 0 EE (2026-09-04) | agent produced no findings file | n/a | BLOCKED | n/a |
...
| poland_pl_3xx_hostgrain | 2026-09-22, laptop | 1998-2001 | `poland_pl_hostgrain.py --redirects-only` over the 19 receipted item CDX indexes on disk, 3xx rows only (ADR-011) | field 2 of the CDX row, IA's own 14-digit capture stamp | n/a | 420.9380 EE, 3,934 net-new of 126,956 host-years, merged260922 (2026-09-22) | 51% www. of a held parent (ADR-008); 13,696 rows ingested | n/a | BANKED | <https://archive.org/details/pl-2001-EXTRACTION-20200922232618-00150-00159-ARC> |
| ia_node_host_cdx_3xx_hostgrain | 2026-09-23, laptop | 2000-2001 | `bulk_cdx_status_split.sh` streaming the node CDX in ranges, 3xx rows only (ADR-011), whole file in two parts | field 2 of the CDX row, IA's own 14-digit capture stamp | n/a | 1,827.8999 EE, 3,615 net-new of 105,715 host-years, merged260922 (2026-09-23) | 11,291 rows ingested | n/a | BANKED | <https://archive.org/download/host_cdx_ia600702/ia600702.hostcdx.gz> |
| global_wayback_cdx_badlines_hostnames | 2026-09-23, laptop | 2000 | the item's one 515.6 MB text file, the lines IA's 2011 global CDX conversion rejected | field 2, IA's 14-digit capture stamp; only 78% hold a valid month | n/a | 4,281.5 EE, 7,914 net-new 2000 host-years by comm vs merged260922 (2026-09-23) | corrupt lines by construction: candidate-grade, never annual | 1 GET | FIND (candidate), not ingested | <https://archive.org/details/GlobalWaybackCdxConversionBadLines20110606> |
...
| ripe1999_nserver_hostnames | 2026-09-02 fleet 20260902T0034Z | 1999 | ftp listing | the dump's own machine-written cut stamp on line 2 of the payload, `# 990804 00:07:01`, the same stamp `ripe_dbase_1999` was approved on.. | n/a | 11400 EE (2026-09-02) | Refused 2026-09-20 by his DNS ruling of 2026-09-06: nserver records are DNS, which dates the parent and not the host | n/a | REFUSED | <https://ftp.funet.fi/pub/netinfo/RIPE/dbase/ripe.db.gz,> [detail](#ripe1999-nserver-hostnames) |
...
| zone_ns_glue_hostnames | 2026-09-02 fleet 20260901T2246Z | 1997 | wayback replay | the zone's own SOA serial `1997041800` on line 2 of the payload (all three zones), fixed in time by IA captures 19970420113748 (org) | n/a | 11862.5 EE (2026-09-02) | Refused 2026-09-20 by his DNS ruling of 2026-09-06: a machine answering in DNS is not a host in use, so N... | n/a | REFUSED | <https://web.archive.org/web/19970420113748id_/http://nic.mil/oroot.html/org.zone.gz> [detail](#zone-ns-glue-hostnames) |
...
| parked_approval_queue_reprice | 2026-09-01 fleet 20260901T1400Z | n/a | n/a | nothing new is dated here.. | n/a | 12024 EE (2026-09-01) | A re-pricing task on sources already registered, not a source of its own. Retired 2026-09-20 so it stops counting as headroom | n/a | NOT A SOURCE | n/a [detail](#parked-approval-queue-reprice) |
...
| FUNET's frozen `netinfo` mirror, swept by its own index | 2026-08-27 | 1996-2001 | robots refusal | n/a | n/a | 66,701.7 EE (2026-08-27) | Retired 2026-09-20: the sweep was done and its own row funet_netinfo_tree_era_artifact_sweep closed at 0 EE, eight directory listings and no payload | 351,368 bytes, 563 files | CLOSED | n/a [detail](#funet-s-frozen-netinfo-mirror-swept-by-its-own-index) |
...
| The VPS journal backlog, and why the cycle undercounted it | 2026-08-27 | n/a | cdx query | n/a | n/a | 40,893.6 EE (2026-08-27) | Retired 2026-09-20: the backlog came home and the VPS collector lane was retired by C-88. That machine now holds no unbanked journals | 416 MB, 125 journals | CLOSED | n/a [detail](#the-vps-journal-backlog-and-why-the-cycle-undercounted-it) |
...
| New Zealand (National Library) | n/a | n/a | cdx query | n/a | n/a | n/a | `webarchive.natlib.govt.nz` and `natlib.govt.nz` return an Imperva bot interstitial. CLOSED on dates 2026-09-22: `identifier:NLNZ-NZ-CRAWL*` sorted by date ascending is 22,828 items whose earliest is 2008, and NLA-AU-CRAWL is 85,412 whose earliest is 2005, so neither national library deposited an in-window index however the interstitial behaves. | n/a | n/a | n/a |
...
| A 2001 squidGuard blacklist | 2026-08-25 | 2001 | n/a | n/a | n/a | 10,736.2 EE (2026-08-25) | Retired 2026-09-20: fetched and measured under squidguard_contrib_2001_hostgrain, which closed at 81.8 EE. The 10,736 EE was the unnetted estimate | 1,852,659 bytes | CLOSED | n/a [detail](#a-2001-squidguard-blacklist) |
...
| The 2001 hunt: five routes closed and one prize sized | 2026-08-25 | 2001 | n/a | n/a | n/a | 273,600 EE (2026-08-25) | Retired 2026-09-20: its own text settles it. The full 2001 .info register does not survive and ICANN's reports are aggregate counts, so the 273,600 EE was never reachable | n/a | CLOSED | n/a [detail](#the-2001-hunt-five-routes-closed-and-one-prize-sized) |
...
| The nw.com survey series | 2026-08-25 | 1996-1997 | n/a | n/a | n/a | 14,956.4 EE (2026-08-25) | Retired 2026-09-20: complete and fully held, the series is semi-annual with no missing edition. Confirmed by measuring the ISC route the same night: 200 TLDs, 13.5M hostnames, 0.03% net-new | n/a | CLOSED | n/a [detail](#the-nw-com-survey-series) |
...
| The Wayback availability endpoint as a SECOND dating engine, and the 2.4M undated pool it was aimed at | 2026-09-23 | 2001 | one query a name at 20010701, VPS | `closest.timestamp` | 40 of 58 hits his | 11.0976 EE (2026-09-23) | read the playback URL as the host (fixed); `{}` for yahoo.com on both IPs | 12.8 EE/client-hour | CLOSED | <https://archive.org/wayback/available?url=> [detail](#the-wayback-availability-endpoint-as-a-second-dating-engine-and-the-2-) |
| CDX exact-host year fill, held at 2000 and missing 2001 (`cdx_yearfill.py`) | 2026-09-23 | 2001 | matchType=host, from=to=2001, limit 1, two laptop lanes, 2,084 names | CDX timestamp field, IA's capture stamp | 74 of 118 hosts hit already his; 5.3% of the queue is his at 2001 though the store says missing | 27.6224 EE (2026-09-23) | his release is archive-derived | 6.82 and 6.72 EE a client-hour | CLOSED | <https://web.archive.org/cdx/search/cdx> |
| Multi-tenant free-host platforms walked to the end of the CDX index (cjb.net first, `cdx_platform_walk.py`) | 2026-09-23 | 1997-2001 | matchType=domain, resumeKey, 2xx+3xx, no collapse, VPS | CDX timestamp, IA's capture stamp | September's sweep skipped failed pages | 13,447.7280 EE (2026-09-23), 32,244 valid net-new host-years in 1.83 h | 3,617 names invalid (underscores) | 7,350 EE/client-hour | BANKING | <https://web.archive.org/cdx/search/cdx?url=cjb.net&matchType=domain> |
| Wildcard and listing names on the researcher's platform list (analdebut.com, jewelry-001.com, eventdb.de) | 2026-09-23 | 2001 | same walker, two laptop lanes | CDX timestamp field, IA's capture stamp | 97.5% of host-years already his | 3,390.9507 EE (2026-09-23), 9,190 valid net-new host-years | utexas.edu and co.yu paid 0, parked | 1,410 and 1,014 EE/client-hour | BANKING | <https://web.archive.org/cdx/search/cdx?url=analdebut.com&matchType=domain> |
...
**Re-measured 2026-09-20.** The 9607 index lists 180 per-TLD files. 178 are ingested: 200 TLDs
across both editions, 13,521,999 distinct hostnames. Netted against his six annual files and his
`candidate_pool.txt`, **4,265 are net-new, a 0.03% rate**, because he holds the ISC survey
himself. Per TLD: `.org` 0.09%, `.net` 0.024%, `.uk` 0.027%. The `hostname_year` delete in
`export.py` drops 287,194 more and every one of them is already in his files, so it costs
nothing and is not the XIII stranding.

The two files never ingested are `com.gz` (22M) and `edu.gz` (13M), the largest two; every other file is 7M or less. The Archive captured neither, in either edition: all four replay URLs return 404 while `uk.gz` returns 4,105,718 B over the same route. Obtained from another mirror they are ~4.5M names, about 1,400 EE at the measured rate, under the 5,000 EE floor. **The ISC route is finished.**
...
Truncated by the archive, and the tail does not exist to be fetched. **Re-tested 2026-09-22 on
three routes.** Wayback serves byte-honest ranges up to the cut, the last 64 bytes matching our
copy exactly, answers 206 with a `content-range` claiming `/20928588915`, and delivers nothing
at or past 2147483648, where offset 2147483640 returns exactly 8 bytes. `ukwa.github.io` is
alive but its whole repo is 108 files whose largest is a 49.6 MB format profile of mime counts.
The British Library record `bl.iro.bl.uk` f8ed3363 has no file attached and its own notes point
back at the dead host. The local copy
...
- result, band by band, and the band EDGES were the thing worth measuring:

  | band | groups | bytes | hostname EE | registrable EE | EE/GB |
  |---|---|---|---|---|---|
  ...
  **The smallest groups are the densest, up to a point.** 63% of a small group's posts fall inside 1996-2001 and
  ...
  assumption, and the band edges are parameters now.
