...
| ia_node_host_cdx_3xx_hostgrain | 2026-09-23, laptop | 2000-2001 | `bulk_cdx_status_split.sh` streaming the node CDX in ranges, 3xx rows only (ADR-011), SURT head through edu,wisc | field 2 of the CDX row, IA's own 14-digit capture stamp | n/a | 1,473.0993 EE, 2,656 net-new of 72,780 host-years, merged260922 (2026-09-23) | 75% www. of a held parent; 8,211 rows ingested; tail still streaming | n/a | BANKED | <https://archive.org/download/host_cdx_ia600702/ia600702.hostcdx.gz> |
