...
| arxiv-bulk-src-ia-mirror-author-mail-hosts | 2026-09-21, laptop | 1996-2001 | all 72 monthly source tars (13.4 GB), author e-mail hosts in TeX, read whole | the tar month names the year | n/a | store 9,537.2 EE hostname grain, 18,786 net-new host-years; registrables seeded as CANDIDATES, 2,951 new names, +1,323.5 EE (2026-09-21) | hostnames XIII outlet; registrables shipped | 72 GETs | PARKED (outlet), SEEDED (candidate) | <https://archive.org/download/arXiv_src_9606_001/> |
