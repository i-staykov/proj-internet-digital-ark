...
| Generated RDAP target populations (2026-08-24) | Four populations of 1,500 to 3,000 names queried direct to Verisign: English dictionary words 13.5 EE per 1,000 queries (28.00% in-window), sibling TLDs of held names 9.7 (5.64% in-window). |
