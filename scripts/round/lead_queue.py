...
def render(rows: list[dict], checked: bool = True) -> str:
    ...
    **Only a measured figure is a row.** A scout's estimate has been wrong by five orders of
    ...
    out = [
        ...
        "scout only estimated is named at the foot and not asked about. No letter to a registry",
        "or an archive is asked for. One yes unlocks everything under its heading.",
        "",
