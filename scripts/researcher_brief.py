...
judgement a collision report cannot make for it.
    ...
    uv run python scripts/researcher_brief.py --slugs a,b,c --budget 2000 --out FILE
"""
...
def collisions(proposal: str) -> str:
    ...
    try:
            ...
            [sys.executable, str(REPO / "scripts/screen_hypothesis.py"), proposal],
            capture_output=True,
            text=True,
            timeout=180,
            cwd=REPO,
...
4. Price with `uv run python scripts/price_items.py`, against merged260830. Sample
