...
is a claim that it was counted.
    ...
    uv run python scripts/harness/decision_sheet.py            # rewrite docs/decisions-open.md
    uv run python scripts/harness/decision_sheet.py --check     # exit 1 if stale, write nothing
"""
...
def main() -> int:
    ...
    if args.check:
        ...
        if have != want:
            print(f"{OUT} is stale; run scripts/harness/decision_sheet.py", file=sys.stderr)
            return 1
        return 0
    OUT.write_text(want)
    print(f"wrote {OUT}")
