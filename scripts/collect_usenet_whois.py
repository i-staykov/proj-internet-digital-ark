...
Writes a journal, never opens the store, uses no network. The split runs after.
    ...
    uv run python scripts/collect_usenet_whois.py --workers 10
    ARK_USENET_SRC=data/raw/usenet_new uv run python scripts/collect_usenet_whois.py
"""
...
def main() -> None:
    ...
    print("\nnext: uv run python scripts/split_usenet_whois.py --write")
